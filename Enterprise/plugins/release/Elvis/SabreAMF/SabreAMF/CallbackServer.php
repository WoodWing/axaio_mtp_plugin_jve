<?php
    ...
    require_once 'AMF3/AbstractMessage.php';
    require_once 'AMF3/AcknowledgeMessage.php';
    require_once 'AMF3/RemotingMessage.php';
    require_once 'AMF3/CommandMessage.php';
    require_once 'AMF3/ErrorMessage.php';
    require_once 'DetailException.php';
