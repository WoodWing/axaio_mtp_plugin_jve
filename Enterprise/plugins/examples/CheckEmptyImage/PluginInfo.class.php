...
class CheckEmptyImage_EnterprisePlugin extends EnterprisePlugin
{
...
foreach (CheckEmptyImage_EnterprisePlugin::getConnectorInterfaces() as $service)
{
	$template = file_get_contents(dirname(__FILE__) . '/Connector.template.php');
	$name = str_replace(' ', '', CheckEmptyImage_EnterprisePlugin::getPluginInfo()->DisplayName);
