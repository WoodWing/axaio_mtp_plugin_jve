...
class AlertLayoutUpdate_EnterprisePlugin extends EnterprisePlugin
{
...
foreach (AlertLayoutUpdate_EnterprisePlugin::getConnectorInterfaces() as $service)
{
	$template = file_get_contents(dirname(__FILE__) . '/Connector.template.php');
	$name = str_replace(' ', '', AlertLayoutUpdate_EnterprisePlugin::getPluginInfo()->DisplayName);
