...
class %classname%_EnterprisePlugin extends EnterprisePlugin
{
...
foreach (%classname%_EnterprisePlugin::getConnectorInterfaces() as $service)
{
	$template = file_get_contents(dirname(__FILE__) . '/Connector.template.php');
	$name = str_replace(' ', '', %classname%_EnterprisePlugin::getPluginInfo()->DisplayName);
