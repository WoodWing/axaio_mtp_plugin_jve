...
class SmartProxy_WflCreateObjectRelations extends WflCreateObjectRelations_EnterpriseConnector
{
	...
	final public function runOverruled (WflCreateObjectRelationsRequest $req) 	
	{
		...
		$resp = SmartProxy::client()->CreateObjectRelations($req);
		$resp = SmartProxy::finish_request($resp);
		return new WflCreateObjectRelationsResponse();
	} 
}
