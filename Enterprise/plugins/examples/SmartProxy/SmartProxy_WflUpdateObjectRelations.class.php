...
class SmartProxy_WflUpdateObjectRelations extends WflUpdateObjectRelations_EnterpriseConnector
{
	...
	final public function runOverruled (WflUpdateObjectRelationsRequest $req) 	
	{
		...
		$resp = SmartProxy::client()->UpdateObjectRelations($req);		
		$resp = SmartProxy::finish_request($resp);
		return new WflUpdateObjectRelationsResponse();
	} 
}
