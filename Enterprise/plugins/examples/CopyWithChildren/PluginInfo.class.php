...
class CopyWithChildren_EnterprisePlugin extends EnterprisePlugin
{
...
foreach (CopyWithChildren_EnterprisePlugin::getConnectorInterfaces() as $service)
{
	$template = file_get_contents(dirname(__FILE__) . '/Connector.template.php');
	$name = str_replace(' ', '', CopyWithChildren_EnterprisePlugin::getPluginInfo()->DisplayName);
