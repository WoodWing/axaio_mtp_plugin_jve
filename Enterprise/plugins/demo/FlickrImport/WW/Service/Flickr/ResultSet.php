 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class WW_Service_Flickr_ResultSet implements SeekableIterator
{
    /**
     ...
     * @param  WW_Service_Flickr $flickr
     * @return void
     */
    public function __construct(DOMDocument $dom, WW_Service_Flickr $flickr)
    {
        $this->_flickr = $flickr;
     ...
     *
     * @return WW_Service_Flickr_Result
     */
    public function current()
    {
        return new WW_Service_Flickr_Result($this->_results->item($this->_currentIndex), $this->_flickr);
    }
