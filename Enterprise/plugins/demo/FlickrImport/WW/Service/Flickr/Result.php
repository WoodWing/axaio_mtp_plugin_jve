 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class WW_Service_Flickr_Result
{
    /**
     ...
     * @param  WW_Service_Flickr $flickr Original Zend_Service_Flickr object with which the request was made
     * @return void
     */
    public function __construct(DOMElement $image, WW_Service_Flickr $flickr)
    {
        ...
        /* WW - Avoid getting the Image Details, as this will slow down a lot on the search process
        $this->_flickr = $flickr;
