...
class PublishFormArticleSelector_EnterprisePlugin extends EnterprisePlugin
{
	public function getPluginInfo()
	{ 
		require_once BASEDIR.'/server/interfaces/plugins/PluginInfoData.class.php';
		$info = new PluginInfoData(); 
		$info->DisplayName = 'Publish Form Article Selector';
		$info->Version     = '9.0 20130828'; 
		$info->Description = 'Example that automatically places Article Components when a Publish Form is first opened';
