...
class WormGraphviz_EnterprisePlugin extends EnterprisePlugin
{
	public function getPluginInfo()
	{ 
		require_once BASEDIR.'/server/interfaces/plugins/PluginInfoData.class.php';
		$info = new PluginInfoData(); 
		$info->DisplayName = 'Worm Graphviz';
		$info->Version     = '9.5 20141210'; // don't use PRODUCTVERSION
		$info->Description = 'WoodWing Object Relation Modeller based on Graphviz.';
