...
/* In case MAMP is used (Mac/Apache/Mysql/PHP) the environment variable
DYLD_LIBRARY_PATH has to be overwritten because otherwise java calls result
in hanging processes.
*/
if (OS == 'UNIX') {
	define('CMDSETENV', 'export DYLD_LIBRARY_PATH="";');
} else {
	define('CMDSETENV', '');
}
