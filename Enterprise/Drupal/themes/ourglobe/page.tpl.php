...
<body class="<?php print $body_classes; ?>">
  ...
  <div id="page"><div id="page-inner">
    ...
    <div id="header-top"><div id="header-top-inner" class="clear-block">
      ...
      <?php if ($header_top): ?>
        <div id="header-top-blocks" class="region region-header">
          <div id="date">
            <?php print $today ?>
            <?php if ($feed_icons): ?>
          <div class="feed-icons"><?php print t('Our RSS Feeds '). $feed_icons; ?></div>
        <?php endif; ?>
          </div>
    ...
    </div></div> <!-- /#header-top-inner, /#header-top -->
    ...
    <div id="main"><div id="main-inner" class="clear-block<?php if ($search_box or $primary_links or $secondary_links or $navbar) { print ' with-navbar'; } ?>">
      ...
      <div id="content"><div id="content-inner">
        ...
        <?php if ($is_front): ?>
          <?php if ($content_left): ?>
            <div id="content-area-left" class="region region-content_left">
        ...
        <?php if ($left): ?>
          <div id="sidebar-left" class="region region-sidebar_left">
            <?php print $left; ?>
          </div> <!-- /#sidebar-left -->
        <?php endif; ?>
