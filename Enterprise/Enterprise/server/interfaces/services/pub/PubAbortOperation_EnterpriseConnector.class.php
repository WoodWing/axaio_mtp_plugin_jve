...
abstract class PubAbortOperation_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'PublishingService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( PubAbortOperationRequest &$req );
	abstract public function runAfter( PubAbortOperationRequest $req, PubAbortOperationResponse &$resp );
	abstract public function runOverruled( PubAbortOperationRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param PubAbortOperationRequest $req The web service request.
