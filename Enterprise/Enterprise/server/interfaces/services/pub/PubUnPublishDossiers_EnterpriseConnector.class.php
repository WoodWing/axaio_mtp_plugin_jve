...
abstract class PubUnPublishDossiers_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'PublishingService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( PubUnPublishDossiersRequest &$req );
	abstract public function runAfter( PubUnPublishDossiersRequest $req, PubUnPublishDossiersResponse &$resp );
	abstract public function runOverruled( PubUnPublishDossiersRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param PubUnPublishDossiersRequest $req The web service request.
