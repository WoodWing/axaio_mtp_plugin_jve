...
abstract class PubPublishDossiers_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'PublishingService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( PubPublishDossiersRequest &$req );
	abstract public function runAfter( PubPublishDossiersRequest $req, PubPublishDossiersResponse &$resp );
	abstract public function runOverruled( PubPublishDossiersRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param PubPublishDossiersRequest $req The web service request.
	 * @param BizException $e The error thrown.
	 */
	public function onError( PubPublishDossiersRequest $req, BizException $e )
	{
