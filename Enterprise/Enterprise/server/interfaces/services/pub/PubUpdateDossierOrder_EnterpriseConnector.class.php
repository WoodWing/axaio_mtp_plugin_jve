...
abstract class PubUpdateDossierOrder_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'PublishingService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( PubUpdateDossierOrderRequest &$req );
	abstract public function runAfter( PubUpdateDossierOrderRequest $req, PubUpdateDossierOrderResponse &$resp );
	abstract public function runOverruled( PubUpdateDossierOrderRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param PubUpdateDossierOrderRequest $req The web service request.
	 * @param BizException $e The error thrown.
	 */
	public function onError( PubUpdateDossierOrderRequest $req, BizException $e )
	{
