...
abstract class PubOperationProgress_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'PublishingService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( PubOperationProgressRequest &$req );
	abstract public function runAfter( PubOperationProgressRequest $req, PubOperationProgressResponse &$resp );
	abstract public function runOverruled( PubOperationProgressRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param PubOperationProgressRequest $req The web service request.
	 * @param BizException $e The error thrown.
	 */
	public function onError( PubOperationProgressRequest $req, BizException $e )
	{
