...
abstract class PubSetPublishInfo_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'PublishingService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( PubSetPublishInfoRequest &$req );
	abstract public function runAfter( PubSetPublishInfoRequest $req, PubSetPublishInfoResponse &$resp );
	abstract public function runOverruled( PubSetPublishInfoRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param PubSetPublishInfoRequest $req The web service request.
