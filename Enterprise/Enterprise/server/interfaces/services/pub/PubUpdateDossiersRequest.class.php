...
class PubUpdateDossiersRequest
{
	public $Ticket;
	public $DossierIDs;
	public $Targets;
	...
	public function validate()
	{
		...
		$validator->enterPath( 'UpdateDossiersRequest' );
	...
	public function getASClassName() { return AS_CLASSNAME_PREFIX.'.pub.PubUpdateDossiersRequest'; } // AMF object type mapping
