...
abstract class PubGetDossierOrder_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'PublishingService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( PubGetDossierOrderRequest &$req );
	abstract public function runAfter( PubGetDossierOrderRequest $req, PubGetDossierOrderResponse &$resp );
	abstract public function runOverruled( PubGetDossierOrderRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param PubGetDossierOrderRequest $req The web service request.
