...
class PubAbortOperationRequest
{
	public $Ticket;
	public $OperationId;
	...
	public function validate()
	{
		...
		$validator->enterPath( 'AbortOperationRequest' );
	...
	public function getASClassName() { return AS_CLASSNAME_PREFIX.'.pub.PubAbortOperationRequest'; } // AMF object type mapping
