...
abstract class PubGetPublishInfo_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'PublishingService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( PubGetPublishInfoRequest &$req );
	abstract public function runAfter( PubGetPublishInfoRequest $req, PubGetPublishInfoResponse &$resp );
	abstract public function runOverruled( PubGetPublishInfoRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param PubGetPublishInfoRequest $req The web service request.
	 * @param BizException $e The error thrown.
	 */
	public function onError( PubGetPublishInfoRequest $req, BizException $e )
	{
	}
}
