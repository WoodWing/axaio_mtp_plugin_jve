...
abstract class PubUpdateDossiers_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'PublishingService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( PubUpdateDossiersRequest &$req );
	abstract public function runAfter( PubUpdateDossiersRequest $req, PubUpdateDossiersResponse &$resp );
	abstract public function runOverruled( PubUpdateDossiersRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param PubUpdateDossiersRequest $req The web service request.
