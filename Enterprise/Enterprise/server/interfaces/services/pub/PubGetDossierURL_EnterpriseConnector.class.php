...
abstract class PubGetDossierURL_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'PublishingService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( PubGetDossierURLRequest &$req );
	abstract public function runAfter( PubGetDossierURLRequest $req, PubGetDossierURLResponse &$resp );
	abstract public function runOverruled( PubGetDossierURLRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param PubGetDossierURLRequest $req The web service request.
	 * @param BizException $e The error thrown.
	 */
	public function onError( PubGetDossierURLRequest $req, BizException $e )
	{
	}
}
