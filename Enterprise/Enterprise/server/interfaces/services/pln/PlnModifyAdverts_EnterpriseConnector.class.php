...
abstract class PlnModifyAdverts_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'PlanningService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( PlnModifyAdvertsRequest &$req );
	abstract public function runAfter( PlnModifyAdvertsRequest $req, PlnModifyAdvertsResponse &$resp );
	abstract public function runOverruled( PlnModifyAdvertsRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param PlnModifyAdvertsRequest $req The web service request.
