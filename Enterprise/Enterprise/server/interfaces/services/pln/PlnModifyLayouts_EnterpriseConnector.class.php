...
abstract class PlnModifyLayouts_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'PlanningService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( PlnModifyLayoutsRequest &$req );
	abstract public function runAfter( PlnModifyLayoutsRequest $req, PlnModifyLayoutsResponse &$resp );
	abstract public function runOverruled( PlnModifyLayoutsRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param PlnModifyLayoutsRequest $req The web service request.
	 * @param BizException $e The error thrown.
	 */
	public function onError( PlnModifyLayoutsRequest $req, BizException $e )
	{
	}
}
