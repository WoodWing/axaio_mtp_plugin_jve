...
abstract class PlnLogOff_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'PlanningService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( PlnLogOffRequest &$req );
	abstract public function runAfter( PlnLogOffRequest $req, PlnLogOffResponse &$resp );
	abstract public function runOverruled( PlnLogOffRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param PlnLogOffRequest $req The web service request.
