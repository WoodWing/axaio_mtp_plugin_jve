...
abstract class PlnDeleteLayouts_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'PlanningService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( PlnDeleteLayoutsRequest &$req );
	abstract public function runAfter( PlnDeleteLayoutsRequest $req, PlnDeleteLayoutsResponse &$resp );
	abstract public function runOverruled( PlnDeleteLayoutsRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param PlnDeleteLayoutsRequest $req The web service request.
	 * @param BizException $e The error thrown.
	 */
	public function onError( PlnDeleteLayoutsRequest $req, BizException $e )
	{
