...
abstract class PlnLogOn_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'PlanningService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( PlnLogOnRequest &$req );
	abstract public function runAfter( PlnLogOnRequest $req, PlnLogOnResponse &$resp );
	abstract public function runOverruled( PlnLogOnRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param PlnLogOnRequest $req The web service request.
