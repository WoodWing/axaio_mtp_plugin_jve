...
abstract class PlnCreateLayouts_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'PlanningService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( PlnCreateLayoutsRequest &$req );
	abstract public function runAfter( PlnCreateLayoutsRequest $req, PlnCreateLayoutsResponse &$resp );
	abstract public function runOverruled( PlnCreateLayoutsRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param PlnCreateLayoutsRequest $req The web service request.
