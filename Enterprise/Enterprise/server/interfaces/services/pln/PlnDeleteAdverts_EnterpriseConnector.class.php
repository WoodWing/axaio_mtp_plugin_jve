...
abstract class PlnDeleteAdverts_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'PlanningService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( PlnDeleteAdvertsRequest &$req );
	abstract public function runAfter( PlnDeleteAdvertsRequest $req, PlnDeleteAdvertsResponse &$resp );
	abstract public function runOverruled( PlnDeleteAdvertsRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param PlnDeleteAdvertsRequest $req The web service request.
	 * @param BizException $e The error thrown.
	 */
	public function onError( PlnDeleteAdvertsRequest $req, BizException $e )
	{
	}
}
