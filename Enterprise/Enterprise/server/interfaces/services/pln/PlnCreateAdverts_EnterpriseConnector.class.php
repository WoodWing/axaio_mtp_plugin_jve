...
abstract class PlnCreateAdverts_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'PlanningService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( PlnCreateAdvertsRequest &$req );
	abstract public function runAfter( PlnCreateAdvertsRequest $req, PlnCreateAdvertsResponse &$resp );
	abstract public function runOverruled( PlnCreateAdvertsRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param PlnCreateAdvertsRequest $req The web service request.
	 * @param BizException $e The error thrown.
	 */
	public function onError( PlnCreateAdvertsRequest $req, BizException $e )
	{
