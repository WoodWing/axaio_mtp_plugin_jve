...
abstract class WflRemoveObjectLabels_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'WorkflowService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( WflRemoveObjectLabelsRequest &$req );
	abstract public function runAfter( WflRemoveObjectLabelsRequest $req, WflRemoveObjectLabelsResponse &$resp );
	abstract public function runOverruled( WflRemoveObjectLabelsRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param WflRemoveObjectLabelsRequest $req The web service request.
	 * @param BizException $e The error thrown.
	 */
	public function onError( WflRemoveObjectLabelsRequest $req, BizException $e )
	{
