...
abstract class WflLogOff_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'WorkflowService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( WflLogOffRequest &$req );
	abstract public function runAfter( WflLogOffRequest $req, WflLogOffResponse &$resp );
	abstract public function runOverruled( WflLogOffRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param WflLogOffRequest $req The web service request.
	 * @param BizException $e The error thrown.
	 */
	public function onError( WflLogOffRequest $req, BizException $e )
	{
	}
}
