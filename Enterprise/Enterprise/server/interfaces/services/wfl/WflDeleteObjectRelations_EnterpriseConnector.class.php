...
abstract class WflDeleteObjectRelations_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'WorkflowService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( WflDeleteObjectRelationsRequest &$req );
	abstract public function runAfter( WflDeleteObjectRelationsRequest $req, WflDeleteObjectRelationsResponse &$resp );
	abstract public function runOverruled( WflDeleteObjectRelationsRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param WflDeleteObjectRelationsRequest $req The web service request.
