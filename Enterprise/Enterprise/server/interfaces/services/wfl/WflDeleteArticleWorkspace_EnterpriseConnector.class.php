...
abstract class WflDeleteArticleWorkspace_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'WorkflowService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( WflDeleteArticleWorkspaceRequest &$req );
	abstract public function runAfter( WflDeleteArticleWorkspaceRequest $req, WflDeleteArticleWorkspaceResponse &$resp );
	abstract public function runOverruled( WflDeleteArticleWorkspaceRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param WflDeleteArticleWorkspaceRequest $req The web service request.
