...
abstract class WflSetObjectProperties_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'WorkflowService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( WflSetObjectPropertiesRequest &$req );
	abstract public function runAfter( WflSetObjectPropertiesRequest $req, WflSetObjectPropertiesResponse &$resp );
	abstract public function runOverruled( WflSetObjectPropertiesRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param WflSetObjectPropertiesRequest $req The web service request.
