...
abstract class WflInstantiateTemplate_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'WorkflowService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( WflInstantiateTemplateRequest &$req );
	abstract public function runAfter( WflInstantiateTemplateRequest $req, WflInstantiateTemplateResponse &$resp );
	abstract public function runOverruled( WflInstantiateTemplateRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param WflInstantiateTemplateRequest $req The web service request.
