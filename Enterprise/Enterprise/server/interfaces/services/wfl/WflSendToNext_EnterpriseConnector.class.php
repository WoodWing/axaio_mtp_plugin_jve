...
abstract class WflSendToNext_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'WorkflowService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( WflSendToNextRequest &$req );
	abstract public function runAfter( WflSendToNextRequest $req, WflSendToNextResponse &$resp );
	abstract public function runOverruled( WflSendToNextRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param WflSendToNextRequest $req The web service request.
	 * @param BizException $e The error thrown.
	 */
	public function onError( WflSendToNextRequest $req, BizException $e )
	{
	}
}
