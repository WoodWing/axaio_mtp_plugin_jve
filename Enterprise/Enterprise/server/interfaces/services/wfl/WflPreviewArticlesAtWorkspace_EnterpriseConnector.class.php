...
abstract class WflPreviewArticlesAtWorkspace_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'WorkflowService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( WflPreviewArticlesAtWorkspaceRequest &$req );
	abstract public function runAfter( WflPreviewArticlesAtWorkspaceRequest $req, WflPreviewArticlesAtWorkspaceResponse &$resp );
	abstract public function runOverruled( WflPreviewArticlesAtWorkspaceRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param WflPreviewArticlesAtWorkspaceRequest $req The web service request.
