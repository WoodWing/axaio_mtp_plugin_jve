...
abstract class WflGetUserSettings_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'WorkflowService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( WflGetUserSettingsRequest &$req );
	abstract public function runAfter( WflGetUserSettingsRequest $req, WflGetUserSettingsResponse &$resp );
	abstract public function runOverruled( WflGetUserSettingsRequest $req );
	 ...
	 *
	 * @param WflGetUserSettingsRequest $req The web service request.
	 * @param BizException $e The error thrown.
	 */
	public function onError( WflGetUserSettingsRequest $req, BizException $e )
	{
	}
}
