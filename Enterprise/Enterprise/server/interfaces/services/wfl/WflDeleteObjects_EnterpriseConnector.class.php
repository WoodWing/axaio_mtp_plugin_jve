...
abstract class WflDeleteObjects_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'WorkflowService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( WflDeleteObjectsRequest &$req );
	abstract public function runAfter( WflDeleteObjectsRequest $req, WflDeleteObjectsResponse &$resp );
	abstract public function runOverruled( WflDeleteObjectsRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param WflDeleteObjectsRequest $req The web service request.
	 * @param BizException $e The error thrown.
	 */
	public function onError( WflDeleteObjectsRequest $req, BizException $e )
	{
