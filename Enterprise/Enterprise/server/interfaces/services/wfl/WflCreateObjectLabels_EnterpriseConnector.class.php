...
abstract class WflCreateObjectLabels_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'WorkflowService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( WflCreateObjectLabelsRequest &$req );
	abstract public function runAfter( WflCreateObjectLabelsRequest $req, WflCreateObjectLabelsResponse &$resp );
	abstract public function runOverruled( WflCreateObjectLabelsRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param WflCreateObjectLabelsRequest $req The web service request.
	 * @param BizException $e The error thrown.
	 */
	public function onError( WflCreateObjectLabelsRequest $req, BizException $e )
	{
	}
}
