...
class Placement
{
	 ...
	 * @param string[]             $InDesignArticleIds   Nullable.
	 * @param string               $FrameType            Nullable.
	 * @param string               $SplineID             Nullable.
	 */
	public function __construct( $Page=null, $Element=null, $ElementID=null, $FrameOrder=null, $FrameID=null, $Left=null, $Top=null, $Width=null, $Height=null, $Overset=null, $OversetChars=null, $OversetLines=null, $Layer=null, $Content=null, $Edition=null, $ContentDx=null, $ContentDy=null, $ScaleX=null, $ScaleY=null, $PageSequence=null, $PageNumber=null, $Tiles=null, $FormWidgetId=null, $InDesignArticleIds=null, $FrameType=null, $SplineID=null)
	{
		$this->Page                 = $Page;
	...
	public function sanitizeProperties4Php()
	{
		...
		if (0 < count($this->InDesignArticleIds)){
			if (is_object($this->InDesignArticleIds[0])){
				foreach ($this->InDesignArticleIds as $complexField){
					$complexField->sanitizeProperties4Php();
				}
			}
		}
...
class Object
{
	 ...
	 * @param Placement[]          $Placements           Nullable.
	 * @param ObjectOperation[]    $Operations           Nullable.
	 */
	public function __construct( $MetaData=null, $Relations=null, $Pages=null, $Files=null, $Messages=null, $Elements=null, $Targets=null, $Renditions=null, $MessageList=null, $ObjectLabels=null, $InDesignArticles=null, $Placements=null, $Operations=null)
	{
	...
	public function sanitizeProperties4Php()
	{
		...
		if (0 < count($this->InDesignArticles)){
			if (is_object($this->InDesignArticles[0])){
				foreach ($this->InDesignArticles as $complexField){
					$complexField->sanitizeProperties4Php();
				}
			}
		}
...
class Param
{
	...
	public function getASClassName() { return AS_CLASSNAME_PREFIX.'.wfl.dataclasses.WflParam'; } // AMF object type mapping
...
class ObjectOperation
{
	 ...
	 * @param Param[]              $Params               
	 */
	public function __construct( $Id=null, $Name=null, $Type=null, $Params=null)
	{
		$this->Id                   = $Id;
		$this->Name                 = $Name;
		$this->Type                 = $Type;
	...
	public function getASClassName() { return AS_CLASSNAME_PREFIX.'.wfl.dataclasses.WflObjectOperation'; } // AMF object type mapping
...
class MessageQueueConnection
{
	 ...
	 */
	public function __construct( $Instance=null, $Protocol=null, $Url=null, $Public=null, $User=null, $Password=null, $VirtualHost=null)
	{
		$this->Instance             = $Instance;
	...
	public function sanitizeProperties4Php()
	{
		if (!is_null($this->Public)){ $this->Public = ('true' == $this->Public) ? true : false; }
	}
}
class EditionPages
{
