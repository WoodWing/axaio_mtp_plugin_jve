...
abstract class WflCreateArticleWorkspace_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'WorkflowService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( WflCreateArticleWorkspaceRequest &$req );
	abstract public function runAfter( WflCreateArticleWorkspaceRequest $req, WflCreateArticleWorkspaceResponse &$resp );
	abstract public function runOverruled( WflCreateArticleWorkspaceRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param WflCreateArticleWorkspaceRequest $req The web service request.
	 * @param BizException $e The error thrown.
	 */
	public function onError( WflCreateArticleWorkspaceRequest $req, BizException $e )
	{
	}
}
