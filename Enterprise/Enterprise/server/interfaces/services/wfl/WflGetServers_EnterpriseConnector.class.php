...
abstract class WflGetServers_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'WorkflowService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( WflGetServersRequest &$req );
	abstract public function runAfter( WflGetServersRequest $req, WflGetServersResponse &$resp );
	abstract public function runOverruled( WflGetServersRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param WflGetServersRequest $req The web service request.
	 * @param BizException $e The error thrown.
	 */
	public function onError( WflGetServersRequest $req, BizException $e )
	{
