...
abstract class WflListArticleWorkspaces_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'WorkflowService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( WflListArticleWorkspacesRequest &$req );
	abstract public function runAfter( WflListArticleWorkspacesRequest $req, WflListArticleWorkspacesResponse &$resp );
	abstract public function runOverruled( WflListArticleWorkspacesRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param WflListArticleWorkspacesRequest $req The web service request.
