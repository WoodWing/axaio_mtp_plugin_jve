...
abstract class WflCreateObjectOperations_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'WorkflowService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( WflCreateObjectOperationsRequest &$req );
	abstract public function runAfter( WflCreateObjectOperationsRequest $req, WflCreateObjectOperationsResponse &$resp );
	abstract public function runOverruled( WflCreateObjectOperationsRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param WflCreateObjectOperationsRequest $req The web service request.
	 * @param BizException $e The error thrown.
	 */
	public function onError( WflCreateObjectOperationsRequest $req, BizException $e )
	{
	}
}
