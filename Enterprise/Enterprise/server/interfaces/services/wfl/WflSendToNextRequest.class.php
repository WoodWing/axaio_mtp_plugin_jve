...
class WflSendToNextRequest
{
	...
	public function validate()
	{
		...
		$validator->enterPath( 'SendToNextRequest' );
	...
	public function getASClassName() { return AS_CLASSNAME_PREFIX.'.wfl.WflSendToNextRequest'; } // AMF object type mapping
