...
abstract class WflGetRelatedPages_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'WorkflowService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( WflGetRelatedPagesRequest &$req );
	abstract public function runAfter( WflGetRelatedPagesRequest $req, WflGetRelatedPagesResponse &$resp );
	abstract public function runOverruled( WflGetRelatedPagesRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param WflGetRelatedPagesRequest $req The web service request.
	 * @param BizException $e The error thrown.
	 */
	public function onError( WflGetRelatedPagesRequest $req, BizException $e )
	{
	}
}
