...
abstract class WflSendMessages_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'WorkflowService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( WflSendMessagesRequest &$req );
	abstract public function runAfter( WflSendMessagesRequest $req, WflSendMessagesResponse &$resp );
	abstract public function runOverruled( WflSendMessagesRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param WflSendMessagesRequest $req The web service request.
	 * @param BizException $e The error thrown.
	 */
	public function onError( WflSendMessagesRequest $req, BizException $e )
	{
