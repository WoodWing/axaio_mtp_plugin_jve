...
abstract class WflRestoreObjects_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'WorkflowService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( WflRestoreObjectsRequest &$req );
	abstract public function runAfter( WflRestoreObjectsRequest $req, WflRestoreObjectsResponse &$resp );
	abstract public function runOverruled( WflRestoreObjectsRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param WflRestoreObjectsRequest $req The web service request.
	 * @param BizException $e The error thrown.
	 */
	public function onError( WflRestoreObjectsRequest $req, BizException $e )
	{
	}
}
