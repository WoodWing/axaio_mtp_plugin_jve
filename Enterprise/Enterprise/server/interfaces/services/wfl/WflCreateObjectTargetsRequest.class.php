...
class WflCreateObjectTargetsRequest
{
	public $Ticket;
	public $IDs;
	public $Targets;
	 ...
	 */
	public function __construct( $Ticket=null, $IDs=null, $Targets=null )
	{
		$this->Ticket               = $Ticket;
		$this->IDs                  = $IDs;
	...
	public function validate()
	{
		...
		$validator->enterPath( 'CreateObjectTargetsRequest' );
	...
	public function getASClassName() { return AS_CLASSNAME_PREFIX.'.wfl.WflCreateObjectTargetsRequest'; } // AMF object type mapping
