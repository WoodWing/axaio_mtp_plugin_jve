...
abstract class WflListVersions_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'WorkflowService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( WflListVersionsRequest &$req );
	abstract public function runAfter( WflListVersionsRequest $req, WflListVersionsResponse &$resp );
	abstract public function runOverruled( WflListVersionsRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param WflListVersionsRequest $req The web service request.
	 * @param BizException $e The error thrown.
	 */
	public function onError( WflListVersionsRequest $req, BizException $e )
	{
	}
}
