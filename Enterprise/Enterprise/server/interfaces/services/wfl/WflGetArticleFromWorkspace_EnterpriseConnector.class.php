...
abstract class WflGetArticleFromWorkspace_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'WorkflowService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( WflGetArticleFromWorkspaceRequest &$req );
	abstract public function runAfter( WflGetArticleFromWorkspaceRequest $req, WflGetArticleFromWorkspaceResponse &$resp );
	abstract public function runOverruled( WflGetArticleFromWorkspaceRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param WflGetArticleFromWorkspaceRequest $req The web service request.
	 * @param BizException $e The error thrown.
	 */
	public function onError( WflGetArticleFromWorkspaceRequest $req, BizException $e )
	{
