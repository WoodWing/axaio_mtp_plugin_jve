...
abstract class WflChangeOnlineStatus_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'WorkflowService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( WflChangeOnlineStatusRequest &$req );
	abstract public function runAfter( WflChangeOnlineStatusRequest $req, WflChangeOnlineStatusResponse &$resp );
	abstract public function runOverruled( WflChangeOnlineStatusRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param WflChangeOnlineStatusRequest $req The web service request.
