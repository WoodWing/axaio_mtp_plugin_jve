...
abstract class WflDeleteObjectTargets_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'WorkflowService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( WflDeleteObjectTargetsRequest &$req );
	abstract public function runAfter( WflDeleteObjectTargetsRequest $req, WflDeleteObjectTargetsResponse &$resp );
	abstract public function runOverruled( WflDeleteObjectTargetsRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param WflDeleteObjectTargetsRequest $req The web service request.
