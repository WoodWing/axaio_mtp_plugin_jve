...
abstract class WflCopyObject_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'WorkflowService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( WflCopyObjectRequest &$req );
	abstract public function runAfter( WflCopyObjectRequest $req, WflCopyObjectResponse &$resp );
	abstract public function runOverruled( WflCopyObjectRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param WflCopyObjectRequest $req The web service request.
	 * @param BizException $e The error thrown.
	 */
	public function onError( WflCopyObjectRequest $req, BizException $e )
	{
	}
}
