...
abstract class WflLogOn_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'WorkflowService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( WflLogOnRequest &$req );
	abstract public function runAfter( WflLogOnRequest $req, WflLogOnResponse &$resp );
	abstract public function runOverruled( WflLogOnRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param WflLogOnRequest $req The web service request.
