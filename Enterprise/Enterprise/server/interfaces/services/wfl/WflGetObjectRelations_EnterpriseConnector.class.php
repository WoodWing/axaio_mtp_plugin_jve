...
abstract class WflGetObjectRelations_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'WorkflowService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( WflGetObjectRelationsRequest &$req );
	abstract public function runAfter( WflGetObjectRelationsRequest $req, WflGetObjectRelationsResponse &$resp );
	abstract public function runOverruled( WflGetObjectRelationsRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param WflGetObjectRelationsRequest $req The web service request.
	 * @param BizException $e The error thrown.
	 */
	public function onError( WflGetObjectRelationsRequest $req, BizException $e )
	{
	}
}
