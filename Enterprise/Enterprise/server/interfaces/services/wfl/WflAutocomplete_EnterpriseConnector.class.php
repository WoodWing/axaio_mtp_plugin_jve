...
abstract class WflAutocomplete_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'WorkflowService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( WflAutocompleteRequest &$req );
	abstract public function runAfter( WflAutocompleteRequest $req, WflAutocompleteResponse &$resp );
	abstract public function runOverruled( WflAutocompleteRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param WflAutocompleteRequest $req The web service request.
	 * @param BizException $e The error thrown.
	 */
	public function onError( WflAutocompleteRequest $req, BizException $e )
	{
	}
}
