...
abstract class WflUpdateObjectTargets_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'WorkflowService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( WflUpdateObjectTargetsRequest &$req );
	abstract public function runAfter( WflUpdateObjectTargetsRequest $req, WflUpdateObjectTargetsResponse &$resp );
	abstract public function runOverruled( WflUpdateObjectTargetsRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param WflUpdateObjectTargetsRequest $req The web service request.
