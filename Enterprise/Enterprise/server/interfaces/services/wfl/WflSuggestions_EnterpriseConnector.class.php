...
abstract class WflSuggestions_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'WorkflowService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( WflSuggestionsRequest &$req );
	abstract public function runAfter( WflSuggestionsRequest $req, WflSuggestionsResponse &$resp );
	abstract public function runOverruled( WflSuggestionsRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param WflSuggestionsRequest $req The web service request.
	 * @param BizException $e The error thrown.
	 */
	public function onError( WflSuggestionsRequest $req, BizException $e )
	{
	}
}
