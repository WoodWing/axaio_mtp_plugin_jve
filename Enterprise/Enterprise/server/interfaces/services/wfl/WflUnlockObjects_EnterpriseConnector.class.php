...
abstract class WflUnlockObjects_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'WorkflowService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( WflUnlockObjectsRequest &$req );
	abstract public function runAfter( WflUnlockObjectsRequest $req, WflUnlockObjectsResponse &$resp );
	abstract public function runOverruled( WflUnlockObjectsRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param WflUnlockObjectsRequest $req The web service request.
