...
abstract class WflAddObjectLabels_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'WorkflowService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( WflAddObjectLabelsRequest &$req );
	abstract public function runAfter( WflAddObjectLabelsRequest $req, WflAddObjectLabelsResponse &$resp );
	abstract public function runOverruled( WflAddObjectLabelsRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param WflAddObjectLabelsRequest $req The web service request.
