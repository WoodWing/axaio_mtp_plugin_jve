...
abstract class WflGetSuggestions_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'WorkflowService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( WflGetSuggestionsRequest &$req );
	abstract public function runAfter( WflGetSuggestionsRequest $req, WflGetSuggestionsResponse &$resp );
	abstract public function runOverruled( WflGetSuggestionsRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param WflGetSuggestionsRequest $req The web service request.
