...
abstract class WflPreviewArticleAtWorkspace_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'WorkflowService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( WflPreviewArticleAtWorkspaceRequest &$req );
	abstract public function runAfter( WflPreviewArticleAtWorkspaceRequest $req, WflPreviewArticleAtWorkspaceResponse &$resp );
	abstract public function runOverruled( WflPreviewArticleAtWorkspaceRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param WflPreviewArticleAtWorkspaceRequest $req The web service request.
	 * @param BizException $e The error thrown.
	 */
	public function onError( WflPreviewArticleAtWorkspaceRequest $req, BizException $e )
	{
	}
}
