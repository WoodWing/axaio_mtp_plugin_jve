...
abstract class WflSaveArticleInWorkspace_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'WorkflowService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( WflSaveArticleInWorkspaceRequest &$req );
	abstract public function runAfter( WflSaveArticleInWorkspaceRequest $req, WflSaveArticleInWorkspaceResponse &$resp );
	abstract public function runOverruled( WflSaveArticleInWorkspaceRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param WflSaveArticleInWorkspaceRequest $req The web service request.
