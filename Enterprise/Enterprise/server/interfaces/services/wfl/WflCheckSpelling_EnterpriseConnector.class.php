...
abstract class WflCheckSpelling_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'WorkflowService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( WflCheckSpellingRequest &$req );
	abstract public function runAfter( WflCheckSpellingRequest $req, WflCheckSpellingResponse &$resp );
	abstract public function runOverruled( WflCheckSpellingRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param WflCheckSpellingRequest $req The web service request.
	 * @param BizException $e The error thrown.
	 */
	public function onError( WflCheckSpellingRequest $req, BizException $e )
	{
