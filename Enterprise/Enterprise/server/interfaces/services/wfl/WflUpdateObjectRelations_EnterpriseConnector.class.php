...
abstract class WflUpdateObjectRelations_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'WorkflowService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( WflUpdateObjectRelationsRequest &$req );
	abstract public function runAfter( WflUpdateObjectRelationsRequest $req, WflUpdateObjectRelationsResponse &$resp );
	abstract public function runOverruled( WflUpdateObjectRelationsRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param WflUpdateObjectRelationsRequest $req The web service request.
