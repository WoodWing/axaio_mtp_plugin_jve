...
abstract class WflGetPagesInfo_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'WorkflowService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( WflGetPagesInfoRequest &$req );
	abstract public function runAfter( WflGetPagesInfoRequest $req, WflGetPagesInfoResponse &$resp );
	abstract public function runOverruled( WflGetPagesInfoRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param WflGetPagesInfoRequest $req The web service request.
