...
abstract class WflDeleteObjectLabels_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'WorkflowService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( WflDeleteObjectLabelsRequest &$req );
	abstract public function runAfter( WflDeleteObjectLabelsRequest $req, WflDeleteObjectLabelsResponse &$resp );
	abstract public function runOverruled( WflDeleteObjectLabelsRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param WflDeleteObjectLabelsRequest $req The web service request.
