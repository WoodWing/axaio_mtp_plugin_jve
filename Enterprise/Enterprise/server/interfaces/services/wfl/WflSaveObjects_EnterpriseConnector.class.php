...
abstract class WflSaveObjects_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'WorkflowService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( WflSaveObjectsRequest &$req );
	abstract public function runAfter( WflSaveObjectsRequest $req, WflSaveObjectsResponse &$resp );
	abstract public function runOverruled( WflSaveObjectsRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param WflSaveObjectsRequest $req The web service request.
	 * @param BizException $e The error thrown.
	 */
	public function onError( WflSaveObjectsRequest $req, BizException $e )
	{
	}
}
