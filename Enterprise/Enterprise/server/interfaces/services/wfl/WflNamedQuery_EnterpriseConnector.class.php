...
abstract class WflNamedQuery_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'WorkflowService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( WflNamedQueryRequest &$req );
	abstract public function runAfter( WflNamedQueryRequest $req, WflNamedQueryResponse &$resp );
	abstract public function runOverruled( WflNamedQueryRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param WflNamedQueryRequest $req The web service request.
	 * @param BizException $e The error thrown.
	 */
	public function onError( WflNamedQueryRequest $req, BizException $e )
	{
