...
abstract class WflUpdateObjectLabels_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'WorkflowService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( WflUpdateObjectLabelsRequest &$req );
	abstract public function runAfter( WflUpdateObjectLabelsRequest $req, WflUpdateObjectLabelsResponse &$resp );
	abstract public function runOverruled( WflUpdateObjectLabelsRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param WflUpdateObjectLabelsRequest $req The web service request.
	 * @param BizException $e The error thrown.
	 */
	public function onError( WflUpdateObjectLabelsRequest $req, BizException $e )
	{
	}
}
