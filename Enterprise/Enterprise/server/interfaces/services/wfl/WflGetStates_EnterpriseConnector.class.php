...
abstract class WflGetStates_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'WorkflowService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( WflGetStatesRequest &$req );
	abstract public function runAfter( WflGetStatesRequest $req, WflGetStatesResponse &$resp );
	abstract public function runOverruled( WflGetStatesRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param WflGetStatesRequest $req The web service request.
	 * @param BizException $e The error thrown.
	 */
	public function onError( WflGetStatesRequest $req, BizException $e )
	{
	}
}
