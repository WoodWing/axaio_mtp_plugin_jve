...
abstract class WflGetObjects_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'WorkflowService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( WflGetObjectsRequest &$req );
	abstract public function runAfter( WflGetObjectsRequest $req, WflGetObjectsResponse &$resp );
	abstract public function runOverruled( WflGetObjectsRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param WflGetObjectsRequest $req The web service request.
	 * @param BizException $e The error thrown.
	 */
	public function onError( WflGetObjectsRequest $req, BizException $e )
	{
