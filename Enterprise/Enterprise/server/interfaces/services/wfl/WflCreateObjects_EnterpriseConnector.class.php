...
abstract class WflCreateObjects_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'WorkflowService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( WflCreateObjectsRequest &$req );
	abstract public function runAfter( WflCreateObjectsRequest $req, WflCreateObjectsResponse &$resp );
	abstract public function runOverruled( WflCreateObjectsRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param WflCreateObjectsRequest $req The web service request.
