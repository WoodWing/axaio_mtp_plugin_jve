...
abstract class WflGetRelatedPagesInfo_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'WorkflowService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( WflGetRelatedPagesInfoRequest &$req );
	abstract public function runAfter( WflGetRelatedPagesInfoRequest $req, WflGetRelatedPagesInfoResponse &$resp );
	abstract public function runOverruled( WflGetRelatedPagesInfoRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param WflGetRelatedPagesInfoRequest $req The web service request.
	 * @param BizException $e The error thrown.
	 */
	public function onError( WflGetRelatedPagesInfoRequest $req, BizException $e )
	{
	}
}
