...
abstract class WflCheckSpellingAndSuggest_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'WorkflowService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( WflCheckSpellingAndSuggestRequest &$req );
	abstract public function runAfter( WflCheckSpellingAndSuggestRequest $req, WflCheckSpellingAndSuggestResponse &$resp );
	abstract public function runOverruled( WflCheckSpellingAndSuggestRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param WflCheckSpellingAndSuggestRequest $req The web service request.
