...
abstract class WflCreateObjectTargets_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'WorkflowService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( WflCreateObjectTargetsRequest &$req );
	abstract public function runAfter( WflCreateObjectTargetsRequest $req, WflCreateObjectTargetsResponse &$resp );
	abstract public function runOverruled( WflCreateObjectTargetsRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param WflCreateObjectTargetsRequest $req The web service request.
	 * @param BizException $e The error thrown.
	 */
	public function onError( WflCreateObjectTargetsRequest $req, BizException $e )
	{
	}
}
