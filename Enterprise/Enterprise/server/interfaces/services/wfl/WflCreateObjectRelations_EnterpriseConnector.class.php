...
abstract class WflCreateObjectRelations_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'WorkflowService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( WflCreateObjectRelationsRequest &$req );
	abstract public function runAfter( WflCreateObjectRelationsRequest $req, WflCreateObjectRelationsResponse &$resp );
	abstract public function runOverruled( WflCreateObjectRelationsRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param WflCreateObjectRelationsRequest $req The web service request.
	 * @param BizException $e The error thrown.
	 */
	public function onError( WflCreateObjectRelationsRequest $req, BizException $e )
	{
