...
abstract class WflChangePassword_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'WorkflowService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( WflChangePasswordRequest &$req );
	abstract public function runAfter( WflChangePasswordRequest $req, WflChangePasswordResponse &$resp );
	abstract public function runOverruled( WflChangePasswordRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param WflChangePasswordRequest $req The web service request.
	 * @param BizException $e The error thrown.
	 */
	public function onError( WflChangePasswordRequest $req, BizException $e )
	{
	}
}
