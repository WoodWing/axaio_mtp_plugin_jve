...
abstract class WflRestoreVersion_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'WorkflowService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( WflRestoreVersionRequest &$req );
	abstract public function runAfter( WflRestoreVersionRequest $req, WflRestoreVersionResponse &$resp );
	abstract public function runOverruled( WflRestoreVersionRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param WflRestoreVersionRequest $req The web service request.
