...
abstract class WflQueryObjects_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'WorkflowService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( WflQueryObjectsRequest &$req );
	abstract public function runAfter( WflQueryObjectsRequest $req, WflQueryObjectsResponse &$resp );
	abstract public function runOverruled( WflQueryObjectsRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param WflQueryObjectsRequest $req The web service request.
	 * @param BizException $e The error thrown.
	 */
	public function onError( WflQueryObjectsRequest $req, BizException $e )
	{
