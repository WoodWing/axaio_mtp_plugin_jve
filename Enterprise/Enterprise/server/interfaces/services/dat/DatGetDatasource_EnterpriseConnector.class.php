...
abstract class DatGetDatasource_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'DataSourceService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( DatGetDatasourceRequest &$req );
	abstract public function runAfter( DatGetDatasourceRequest $req, DatGetDatasourceResponse &$resp );
	abstract public function runOverruled( DatGetDatasourceRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param DatGetDatasourceRequest $req The web service request.
	 * @param BizException $e The error thrown.
	 */
	public function onError( DatGetDatasourceRequest $req, BizException $e )
	{
	}
}
