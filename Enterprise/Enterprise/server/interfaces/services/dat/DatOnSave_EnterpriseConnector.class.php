...
abstract class DatOnSave_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'DataSourceService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( DatOnSaveRequest &$req );
	abstract public function runAfter( DatOnSaveRequest $req, DatOnSaveResponse &$resp );
	abstract public function runOverruled( DatOnSaveRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param DatOnSaveRequest $req The web service request.
