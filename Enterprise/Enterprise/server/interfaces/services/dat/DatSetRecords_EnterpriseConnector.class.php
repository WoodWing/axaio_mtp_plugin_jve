...
abstract class DatSetRecords_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'DataSourceService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( DatSetRecordsRequest &$req );
	abstract public function runAfter( DatSetRecordsRequest $req, DatSetRecordsResponse &$resp );
	abstract public function runOverruled( DatSetRecordsRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param DatSetRecordsRequest $req The web service request.
	 * @param BizException $e The error thrown.
	 */
	public function onError( DatSetRecordsRequest $req, BizException $e )
	{
