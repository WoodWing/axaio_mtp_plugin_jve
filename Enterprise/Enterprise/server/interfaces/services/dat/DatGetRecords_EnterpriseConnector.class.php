...
abstract class DatGetRecords_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'DataSourceService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( DatGetRecordsRequest &$req );
	abstract public function runAfter( DatGetRecordsRequest $req, DatGetRecordsResponse &$resp );
	abstract public function runOverruled( DatGetRecordsRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param DatGetRecordsRequest $req The web service request.
	 * @param BizException $e The error thrown.
	 */
	public function onError( DatGetRecordsRequest $req, BizException $e )
	{
	}
}
