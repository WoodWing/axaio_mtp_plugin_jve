...
abstract class DatGetUpdates_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'DataSourceService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( DatGetUpdatesRequest &$req );
	abstract public function runAfter( DatGetUpdatesRequest $req, DatGetUpdatesResponse &$resp );
	abstract public function runOverruled( DatGetUpdatesRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param DatGetUpdatesRequest $req The web service request.
