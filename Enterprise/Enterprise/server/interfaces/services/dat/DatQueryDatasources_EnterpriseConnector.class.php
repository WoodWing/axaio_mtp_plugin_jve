...
abstract class DatQueryDatasources_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'DataSourceService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( DatQueryDatasourcesRequest &$req );
	abstract public function runAfter( DatQueryDatasourcesRequest $req, DatQueryDatasourcesResponse &$resp );
	abstract public function runOverruled( DatQueryDatasourcesRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param DatQueryDatasourcesRequest $req The web service request.
