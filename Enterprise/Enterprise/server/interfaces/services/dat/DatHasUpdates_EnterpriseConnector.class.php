...
abstract class DatHasUpdates_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'DataSourceService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( DatHasUpdatesRequest &$req );
	abstract public function runAfter( DatHasUpdatesRequest $req, DatHasUpdatesResponse &$resp );
	abstract public function runOverruled( DatHasUpdatesRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param DatHasUpdatesRequest $req The web service request.
	 * @param BizException $e The error thrown.
	 */
	public function onError( DatHasUpdatesRequest $req, BizException $e )
	{
	}
}
