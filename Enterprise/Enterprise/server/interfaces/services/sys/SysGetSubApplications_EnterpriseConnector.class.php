...
abstract class SysGetSubApplications_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'SysAdminService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( SysGetSubApplicationsRequest &$req );
	abstract public function runAfter( SysGetSubApplicationsRequest $req, SysGetSubApplicationsResponse &$resp );
	abstract public function runOverruled( SysGetSubApplicationsRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param SysGetSubApplicationsRequest $req The web service request.
	 * @param BizException $e The error thrown.
	 */
	public function onError( SysGetSubApplicationsRequest $req, BizException $e )
	{
