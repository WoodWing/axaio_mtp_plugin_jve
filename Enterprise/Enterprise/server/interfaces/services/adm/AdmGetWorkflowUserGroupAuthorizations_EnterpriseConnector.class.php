...
abstract class AdmGetWorkflowUserGroupAuthorizations_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'AdminService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( AdmGetWorkflowUserGroupAuthorizationsRequest &$req );
	abstract public function runAfter( AdmGetWorkflowUserGroupAuthorizationsRequest $req, AdmGetWorkflowUserGroupAuthorizationsResponse &$resp );
	abstract public function runOverruled( AdmGetWorkflowUserGroupAuthorizationsRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param AdmGetWorkflowUserGroupAuthorizationsRequest $req The web service request.
	 * @param BizException $e The error thrown.
	 */
	public function onError( AdmGetWorkflowUserGroupAuthorizationsRequest $req, BizException $e )
	{
	}
}
