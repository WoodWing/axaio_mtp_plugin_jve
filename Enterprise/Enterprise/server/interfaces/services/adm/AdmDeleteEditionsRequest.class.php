...
class AdmDeleteEditionsRequest
{
	public $Ticket;
	...
	public function validate()
	{
		...
		$validator->enterPath( 'DeleteEditionsRequest' );
		...
		if( $validator->checkExist( $datObj, 'EditionIds' ) ) {
			...
			$validator->checkNull( $datObj->EditionIds );
	...
	public function getASClassName() { return AS_CLASSNAME_PREFIX.'.adm.AdmDeleteEditionsRequest'; } // AMF object type mapping
