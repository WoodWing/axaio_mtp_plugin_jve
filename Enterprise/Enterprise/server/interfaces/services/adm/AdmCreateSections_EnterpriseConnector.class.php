...
abstract class AdmCreateSections_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'AdminService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( AdmCreateSectionsRequest &$req );
	abstract public function runAfter( AdmCreateSectionsRequest $req, AdmCreateSectionsResponse &$resp );
	abstract public function runOverruled( AdmCreateSectionsRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param AdmCreateSectionsRequest $req The web service request.
	 * @param BizException $e The error thrown.
	 */
	public function onError( AdmCreateSectionsRequest $req, BizException $e )
	{
	}
}
