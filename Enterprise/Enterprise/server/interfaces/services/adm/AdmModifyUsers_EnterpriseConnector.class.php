...
abstract class AdmModifyUsers_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'AdminService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( AdmModifyUsersRequest &$req );
	abstract public function runAfter( AdmModifyUsersRequest $req, AdmModifyUsersResponse &$resp );
	abstract public function runOverruled( AdmModifyUsersRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param AdmModifyUsersRequest $req The web service request.
