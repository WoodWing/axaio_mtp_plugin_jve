...
abstract class AdmRemoveGroupsFromUser_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'AdminService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( AdmRemoveGroupsFromUserRequest &$req );
	abstract public function runAfter( AdmRemoveGroupsFromUserRequest $req, AdmRemoveGroupsFromUserResponse &$resp );
	abstract public function runOverruled( AdmRemoveGroupsFromUserRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param AdmRemoveGroupsFromUserRequest $req The web service request.
