...
abstract class AdmGetRoutings_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'AdminService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( AdmGetRoutingsRequest &$req );
	abstract public function runAfter( AdmGetRoutingsRequest $req, AdmGetRoutingsResponse &$resp );
	abstract public function runOverruled( AdmGetRoutingsRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param AdmGetRoutingsRequest $req The web service request.
	 * @param BizException $e The error thrown.
	 */
	public function onError( AdmGetRoutingsRequest $req, BizException $e )
	{
	}
}
