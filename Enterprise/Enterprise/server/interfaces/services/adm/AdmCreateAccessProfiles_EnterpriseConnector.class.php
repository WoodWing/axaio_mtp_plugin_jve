...
abstract class AdmCreateAccessProfiles_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'AdminService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( AdmCreateAccessProfilesRequest &$req );
	abstract public function runAfter( AdmCreateAccessProfilesRequest $req, AdmCreateAccessProfilesResponse &$resp );
	abstract public function runOverruled( AdmCreateAccessProfilesRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param AdmCreateAccessProfilesRequest $req The web service request.
	 * @param BizException $e The error thrown.
	 */
	public function onError( AdmCreateAccessProfilesRequest $req, BizException $e )
	{
