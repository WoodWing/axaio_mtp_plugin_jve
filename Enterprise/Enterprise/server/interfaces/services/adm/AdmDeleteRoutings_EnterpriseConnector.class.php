...
abstract class AdmDeleteRoutings_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'AdminService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( AdmDeleteRoutingsRequest &$req );
	abstract public function runAfter( AdmDeleteRoutingsRequest $req, AdmDeleteRoutingsResponse &$resp );
	abstract public function runOverruled( AdmDeleteRoutingsRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param AdmDeleteRoutingsRequest $req The web service request.
	 * @param BizException $e The error thrown.
	 */
	public function onError( AdmDeleteRoutingsRequest $req, BizException $e )
	{
	}
}
