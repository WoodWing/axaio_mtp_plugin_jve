...
abstract class AdmCreateWorkflowUserGroupAuthorizations_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'AdminService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( AdmCreateWorkflowUserGroupAuthorizationsRequest &$req );
	abstract public function runAfter( AdmCreateWorkflowUserGroupAuthorizationsRequest $req, AdmCreateWorkflowUserGroupAuthorizationsResponse &$resp );
	abstract public function runOverruled( AdmCreateWorkflowUserGroupAuthorizationsRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param AdmCreateWorkflowUserGroupAuthorizationsRequest $req The web service request.
