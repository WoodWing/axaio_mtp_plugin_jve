...
abstract class AdmCreateAutocompleteTermEntities_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'AdminService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( AdmCreateAutocompleteTermEntitiesRequest &$req );
	abstract public function runAfter( AdmCreateAutocompleteTermEntitiesRequest $req, AdmCreateAutocompleteTermEntitiesResponse &$resp );
	abstract public function runOverruled( AdmCreateAutocompleteTermEntitiesRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param AdmCreateAutocompleteTermEntitiesRequest $req The web service request.
