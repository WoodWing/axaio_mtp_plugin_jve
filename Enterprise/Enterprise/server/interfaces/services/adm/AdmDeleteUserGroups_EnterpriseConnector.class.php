...
abstract class AdmDeleteUserGroups_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'AdminService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( AdmDeleteUserGroupsRequest &$req );
	abstract public function runAfter( AdmDeleteUserGroupsRequest $req, AdmDeleteUserGroupsResponse &$resp );
	abstract public function runOverruled( AdmDeleteUserGroupsRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param AdmDeleteUserGroupsRequest $req The web service request.
