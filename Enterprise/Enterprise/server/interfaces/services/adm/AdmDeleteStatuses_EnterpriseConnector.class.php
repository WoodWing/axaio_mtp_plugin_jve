...
abstract class AdmDeleteStatuses_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'AdminService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( AdmDeleteStatusesRequest &$req );
	abstract public function runAfter( AdmDeleteStatusesRequest $req, AdmDeleteStatusesResponse &$resp );
	abstract public function runOverruled( AdmDeleteStatusesRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param AdmDeleteStatusesRequest $req The web service request.
