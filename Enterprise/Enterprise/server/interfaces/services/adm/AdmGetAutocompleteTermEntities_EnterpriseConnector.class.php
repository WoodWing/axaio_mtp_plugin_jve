...
abstract class AdmGetAutocompleteTermEntities_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'AdminService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( AdmGetAutocompleteTermEntitiesRequest &$req );
	abstract public function runAfter( AdmGetAutocompleteTermEntitiesRequest $req, AdmGetAutocompleteTermEntitiesResponse &$resp );
	abstract public function runOverruled( AdmGetAutocompleteTermEntitiesRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param AdmGetAutocompleteTermEntitiesRequest $req The web service request.
