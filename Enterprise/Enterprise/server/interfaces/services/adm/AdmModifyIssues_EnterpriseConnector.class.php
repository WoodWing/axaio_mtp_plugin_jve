...
abstract class AdmModifyIssues_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'AdminService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( AdmModifyIssuesRequest &$req );
	abstract public function runAfter( AdmModifyIssuesRequest $req, AdmModifyIssuesResponse &$resp );
	abstract public function runOverruled( AdmModifyIssuesRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param AdmModifyIssuesRequest $req The web service request.
