...
class AdmCopyIssuesRequest
{
	 ...
	 */
	public function __construct( $Ticket=null, $RequestModes=null, $IssueId=null, $Issues=null )
	{
		$this->Ticket               = $Ticket;
	...
	public function validate()
	{
		...
		$validator->enterPath( 'CopyIssuesRequest' );
	...
	public function getASClassName() { return AS_CLASSNAME_PREFIX.'.adm.AdmCopyIssuesRequest'; } // AMF object type mapping
