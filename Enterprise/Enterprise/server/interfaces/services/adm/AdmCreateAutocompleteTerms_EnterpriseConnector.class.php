...
abstract class AdmCreateAutocompleteTerms_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'AdminService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( AdmCreateAutocompleteTermsRequest &$req );
	abstract public function runAfter( AdmCreateAutocompleteTermsRequest $req, AdmCreateAutocompleteTermsResponse &$resp );
	abstract public function runOverruled( AdmCreateAutocompleteTermsRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param AdmCreateAutocompleteTermsRequest $req The web service request.
