...
abstract class AdmDeletePublications_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'AdminService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( AdmDeletePublicationsRequest &$req );
	abstract public function runAfter( AdmDeletePublicationsRequest $req, AdmDeletePublicationsResponse &$resp );
	abstract public function runOverruled( AdmDeletePublicationsRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param AdmDeletePublicationsRequest $req The web service request.
