...
abstract class AdmDeleteWorkflowUserGroupAuthorizations_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'AdminService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( AdmDeleteWorkflowUserGroupAuthorizationsRequest &$req );
	abstract public function runAfter( AdmDeleteWorkflowUserGroupAuthorizationsRequest $req, AdmDeleteWorkflowUserGroupAuthorizationsResponse &$resp );
	abstract public function runOverruled( AdmDeleteWorkflowUserGroupAuthorizationsRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param AdmDeleteWorkflowUserGroupAuthorizationsRequest $req The web service request.
	 * @param BizException $e The error thrown.
	 */
	public function onError( AdmDeleteWorkflowUserGroupAuthorizationsRequest $req, BizException $e )
	{
	}
}
