...
abstract class AdmGetPublicationAdminAuthorizations_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'AdminService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( AdmGetPublicationAdminAuthorizationsRequest &$req );
	abstract public function runAfter( AdmGetPublicationAdminAuthorizationsRequest $req, AdmGetPublicationAdminAuthorizationsResponse &$resp );
	abstract public function runOverruled( AdmGetPublicationAdminAuthorizationsRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param AdmGetPublicationAdminAuthorizationsRequest $req The web service request.
	 * @param BizException $e The error thrown.
	 */
	public function onError( AdmGetPublicationAdminAuthorizationsRequest $req, BizException $e )
	{
	}
}
