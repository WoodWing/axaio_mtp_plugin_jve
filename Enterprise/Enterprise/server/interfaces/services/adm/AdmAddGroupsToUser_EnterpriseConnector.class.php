...
abstract class AdmAddGroupsToUser_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'AdminService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( AdmAddGroupsToUserRequest &$req );
	abstract public function runAfter( AdmAddGroupsToUserRequest $req, AdmAddGroupsToUserResponse &$resp );
	abstract public function runOverruled( AdmAddGroupsToUserRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param AdmAddGroupsToUserRequest $req The web service request.
	 * @param BizException $e The error thrown.
	 */
	public function onError( AdmAddGroupsToUserRequest $req, BizException $e )
	{
	}
}
