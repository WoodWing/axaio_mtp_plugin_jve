...
abstract class AdmModifyPubChannels_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'AdminService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( AdmModifyPubChannelsRequest &$req );
	abstract public function runAfter( AdmModifyPubChannelsRequest $req, AdmModifyPubChannelsResponse &$resp );
	abstract public function runOverruled( AdmModifyPubChannelsRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param AdmModifyPubChannelsRequest $req The web service request.
