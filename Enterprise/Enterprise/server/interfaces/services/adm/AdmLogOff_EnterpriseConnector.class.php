...
abstract class AdmLogOff_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'AdminService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( AdmLogOffRequest &$req );
	abstract public function runAfter( AdmLogOffRequest $req, AdmLogOffResponse &$resp );
	abstract public function runOverruled( AdmLogOffRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param AdmLogOffRequest $req The web service request.
