...
abstract class AdmModifyUserGroups_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'AdminService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( AdmModifyUserGroupsRequest &$req );
	abstract public function runAfter( AdmModifyUserGroupsRequest $req, AdmModifyUserGroupsResponse &$resp );
	abstract public function runOverruled( AdmModifyUserGroupsRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param AdmModifyUserGroupsRequest $req The web service request.
	 * @param BizException $e The error thrown.
	 */
	public function onError( AdmModifyUserGroupsRequest $req, BizException $e )
	{
	}
}
