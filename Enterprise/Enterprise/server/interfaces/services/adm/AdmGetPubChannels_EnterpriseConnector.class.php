...
abstract class AdmGetPubChannels_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'AdminService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( AdmGetPubChannelsRequest &$req );
	abstract public function runAfter( AdmGetPubChannelsRequest $req, AdmGetPubChannelsResponse &$resp );
	abstract public function runOverruled( AdmGetPubChannelsRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param AdmGetPubChannelsRequest $req The web service request.
	 * @param BizException $e The error thrown.
	 */
	public function onError( AdmGetPubChannelsRequest $req, BizException $e )
	{
	}
}
