...
abstract class AdmModifyAutocompleteTerms_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'AdminService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( AdmModifyAutocompleteTermsRequest &$req );
	abstract public function runAfter( AdmModifyAutocompleteTermsRequest $req, AdmModifyAutocompleteTermsResponse &$resp );
	abstract public function runOverruled( AdmModifyAutocompleteTermsRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param AdmModifyAutocompleteTermsRequest $req The web service request.
	 * @param BizException $e The error thrown.
	 */
	public function onError( AdmModifyAutocompleteTermsRequest $req, BizException $e )
	{
	}
}
