...
abstract class AdmAddTemplateObjects_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'AdminService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( AdmAddTemplateObjectsRequest &$req );
	abstract public function runAfter( AdmAddTemplateObjectsRequest $req, AdmAddTemplateObjectsResponse &$resp );
	abstract public function runOverruled( AdmAddTemplateObjectsRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param AdmAddTemplateObjectsRequest $req The web service request.
	 * @param BizException $e The error thrown.
	 */
	public function onError( AdmAddTemplateObjectsRequest $req, BizException $e )
	{
	}
}
