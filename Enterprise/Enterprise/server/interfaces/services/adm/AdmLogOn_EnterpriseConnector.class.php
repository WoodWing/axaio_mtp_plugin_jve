...
abstract class AdmLogOn_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'AdminService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( AdmLogOnRequest &$req );
	abstract public function runAfter( AdmLogOnRequest $req, AdmLogOnResponse &$resp );
	abstract public function runOverruled( AdmLogOnRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param AdmLogOnRequest $req The web service request.
	 * @param BizException $e The error thrown.
	 */
	public function onError( AdmLogOnRequest $req, BizException $e )
	{
	}
}
