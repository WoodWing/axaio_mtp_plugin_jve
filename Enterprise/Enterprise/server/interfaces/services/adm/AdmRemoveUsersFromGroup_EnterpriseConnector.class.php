...
abstract class AdmRemoveUsersFromGroup_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'AdminService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( AdmRemoveUsersFromGroupRequest &$req );
	abstract public function runAfter( AdmRemoveUsersFromGroupRequest $req, AdmRemoveUsersFromGroupResponse &$resp );
	abstract public function runOverruled( AdmRemoveUsersFromGroupRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param AdmRemoveUsersFromGroupRequest $req The web service request.
	 * @param BizException $e The error thrown.
	 */
	public function onError( AdmRemoveUsersFromGroupRequest $req, BizException $e )
	{
	}
}
