...
abstract class AdmDeleteSections_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'AdminService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( AdmDeleteSectionsRequest &$req );
	abstract public function runAfter( AdmDeleteSectionsRequest $req, AdmDeleteSectionsResponse &$resp );
	abstract public function runOverruled( AdmDeleteSectionsRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param AdmDeleteSectionsRequest $req The web service request.
	 * @param BizException $e The error thrown.
	 */
	public function onError( AdmDeleteSectionsRequest $req, BizException $e )
	{
	}
}
