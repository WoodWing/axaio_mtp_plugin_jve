...
abstract class AdmDeleteAutocompleteTermEntities_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'AdminService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( AdmDeleteAutocompleteTermEntitiesRequest &$req );
	abstract public function runAfter( AdmDeleteAutocompleteTermEntitiesRequest $req, AdmDeleteAutocompleteTermEntitiesResponse &$resp );
	abstract public function runOverruled( AdmDeleteAutocompleteTermEntitiesRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param AdmDeleteAutocompleteTermEntitiesRequest $req The web service request.
