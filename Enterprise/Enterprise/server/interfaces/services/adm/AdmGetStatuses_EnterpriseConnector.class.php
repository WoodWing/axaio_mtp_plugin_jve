...
abstract class AdmGetStatuses_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'AdminService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( AdmGetStatusesRequest &$req );
	abstract public function runAfter( AdmGetStatusesRequest $req, AdmGetStatusesResponse &$resp );
	abstract public function runOverruled( AdmGetStatusesRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param AdmGetStatusesRequest $req The web service request.
	 * @param BizException $e The error thrown.
	 */
	public function onError( AdmGetStatusesRequest $req, BizException $e )
	{
	}
}
