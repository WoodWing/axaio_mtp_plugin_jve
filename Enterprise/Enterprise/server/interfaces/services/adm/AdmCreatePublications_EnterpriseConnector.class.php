...
abstract class AdmCreatePublications_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'AdminService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( AdmCreatePublicationsRequest &$req );
	abstract public function runAfter( AdmCreatePublicationsRequest $req, AdmCreatePublicationsResponse &$resp );
	abstract public function runOverruled( AdmCreatePublicationsRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param AdmCreatePublicationsRequest $req The web service request.
