...
abstract class AdmModifySections_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'AdminService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( AdmModifySectionsRequest &$req );
	abstract public function runAfter( AdmModifySectionsRequest $req, AdmModifySectionsResponse &$resp );
	abstract public function runOverruled( AdmModifySectionsRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param AdmModifySectionsRequest $req The web service request.
	 * @param BizException $e The error thrown.
	 */
	public function onError( AdmModifySectionsRequest $req, BizException $e )
	{
	}
}
