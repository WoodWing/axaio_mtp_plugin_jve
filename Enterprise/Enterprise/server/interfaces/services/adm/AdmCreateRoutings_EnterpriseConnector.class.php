...
abstract class AdmCreateRoutings_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'AdminService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( AdmCreateRoutingsRequest &$req );
	abstract public function runAfter( AdmCreateRoutingsRequest $req, AdmCreateRoutingsResponse &$resp );
	abstract public function runOverruled( AdmCreateRoutingsRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param AdmCreateRoutingsRequest $req The web service request.
