...
abstract class AdmCreateUserGroups_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'AdminService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( AdmCreateUserGroupsRequest &$req );
	abstract public function runAfter( AdmCreateUserGroupsRequest $req, AdmCreateUserGroupsResponse &$resp );
	abstract public function runOverruled( AdmCreateUserGroupsRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param AdmCreateUserGroupsRequest $req The web service request.
