...
abstract class AdmCreatePubChannels_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'AdminService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( AdmCreatePubChannelsRequest &$req );
	abstract public function runAfter( AdmCreatePubChannelsRequest $req, AdmCreatePubChannelsResponse &$resp );
	abstract public function runOverruled( AdmCreatePubChannelsRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param AdmCreatePubChannelsRequest $req The web service request.
	 * @param BizException $e The error thrown.
	 */
	public function onError( AdmCreatePubChannelsRequest $req, BizException $e )
	{
