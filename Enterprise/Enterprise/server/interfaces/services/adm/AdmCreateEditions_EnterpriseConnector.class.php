...
abstract class AdmCreateEditions_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'AdminService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( AdmCreateEditionsRequest &$req );
	abstract public function runAfter( AdmCreateEditionsRequest $req, AdmCreateEditionsResponse &$resp );
	abstract public function runOverruled( AdmCreateEditionsRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param AdmCreateEditionsRequest $req The web service request.
	 * @param BizException $e The error thrown.
	 */
	public function onError( AdmCreateEditionsRequest $req, BizException $e )
	{
