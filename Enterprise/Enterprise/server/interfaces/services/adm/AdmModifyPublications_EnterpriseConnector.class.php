...
abstract class AdmModifyPublications_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'AdminService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( AdmModifyPublicationsRequest &$req );
	abstract public function runAfter( AdmModifyPublicationsRequest $req, AdmModifyPublicationsResponse &$resp );
	abstract public function runOverruled( AdmModifyPublicationsRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param AdmModifyPublicationsRequest $req The web service request.
	 * @param BizException $e The error thrown.
	 */
	public function onError( AdmModifyPublicationsRequest $req, BizException $e )
	{
	}
}
