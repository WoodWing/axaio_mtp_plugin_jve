...
abstract class AdmCreatePublicationAdminAuthorizations_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'AdminService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( AdmCreatePublicationAdminAuthorizationsRequest &$req );
	abstract public function runAfter( AdmCreatePublicationAdminAuthorizationsRequest $req, AdmCreatePublicationAdminAuthorizationsResponse &$resp );
	abstract public function runOverruled( AdmCreatePublicationAdminAuthorizationsRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param AdmCreatePublicationAdminAuthorizationsRequest $req The web service request.
