...
abstract class AdmDeleteAutocompleteTerms_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'AdminService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( AdmDeleteAutocompleteTermsRequest &$req );
	abstract public function runAfter( AdmDeleteAutocompleteTermsRequest $req, AdmDeleteAutocompleteTermsResponse &$resp );
	abstract public function runOverruled( AdmDeleteAutocompleteTermsRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param AdmDeleteAutocompleteTermsRequest $req The web service request.
