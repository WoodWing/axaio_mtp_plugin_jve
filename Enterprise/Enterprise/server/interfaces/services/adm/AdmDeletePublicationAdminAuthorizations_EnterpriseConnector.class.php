...
abstract class AdmDeletePublicationAdminAuthorizations_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'AdminService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( AdmDeletePublicationAdminAuthorizationsRequest &$req );
	abstract public function runAfter( AdmDeletePublicationAdminAuthorizationsRequest $req, AdmDeletePublicationAdminAuthorizationsResponse &$resp );
	abstract public function runOverruled( AdmDeletePublicationAdminAuthorizationsRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param AdmDeletePublicationAdminAuthorizationsRequest $req The web service request.
