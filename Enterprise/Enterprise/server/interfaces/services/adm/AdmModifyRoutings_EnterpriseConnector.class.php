...
abstract class AdmModifyRoutings_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'AdminService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( AdmModifyRoutingsRequest &$req );
	abstract public function runAfter( AdmModifyRoutingsRequest $req, AdmModifyRoutingsResponse &$resp );
	abstract public function runOverruled( AdmModifyRoutingsRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param AdmModifyRoutingsRequest $req The web service request.
	 * @param BizException $e The error thrown.
	 */
	public function onError( AdmModifyRoutingsRequest $req, BizException $e )
	{
	}
}
