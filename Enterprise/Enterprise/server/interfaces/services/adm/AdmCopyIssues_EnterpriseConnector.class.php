...
abstract class AdmCopyIssues_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'AdminService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( AdmCopyIssuesRequest &$req );
	abstract public function runAfter( AdmCopyIssuesRequest $req, AdmCopyIssuesResponse &$resp );
	abstract public function runOverruled( AdmCopyIssuesRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param AdmCopyIssuesRequest $req The web service request.
	 * @param BizException $e The error thrown.
	 */
	public function onError( AdmCopyIssuesRequest $req, BizException $e )
	{
	}
}
