...
abstract class AdmModifyEditions_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'AdminService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( AdmModifyEditionsRequest &$req );
	abstract public function runAfter( AdmModifyEditionsRequest $req, AdmModifyEditionsResponse &$resp );
	abstract public function runOverruled( AdmModifyEditionsRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param AdmModifyEditionsRequest $req The web service request.
	 * @param BizException $e The error thrown.
	 */
	public function onError( AdmModifyEditionsRequest $req, BizException $e )
	{
