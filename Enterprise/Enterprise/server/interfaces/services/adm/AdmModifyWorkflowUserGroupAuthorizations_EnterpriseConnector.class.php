...
abstract class AdmModifyWorkflowUserGroupAuthorizations_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'AdminService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( AdmModifyWorkflowUserGroupAuthorizationsRequest &$req );
	abstract public function runAfter( AdmModifyWorkflowUserGroupAuthorizationsRequest $req, AdmModifyWorkflowUserGroupAuthorizationsResponse &$resp );
	abstract public function runOverruled( AdmModifyWorkflowUserGroupAuthorizationsRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param AdmModifyWorkflowUserGroupAuthorizationsRequest $req The web service request.
	 * @param BizException $e The error thrown.
	 */
	public function onError( AdmModifyWorkflowUserGroupAuthorizationsRequest $req, BizException $e )
	{
	}
}
