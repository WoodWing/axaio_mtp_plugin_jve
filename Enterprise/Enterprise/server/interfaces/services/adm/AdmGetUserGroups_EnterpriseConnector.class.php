...
abstract class AdmGetUserGroups_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'AdminService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( AdmGetUserGroupsRequest &$req );
	abstract public function runAfter( AdmGetUserGroupsRequest $req, AdmGetUserGroupsResponse &$resp );
	abstract public function runOverruled( AdmGetUserGroupsRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param AdmGetUserGroupsRequest $req The web service request.
	 * @param BizException $e The error thrown.
	 */
	public function onError( AdmGetUserGroupsRequest $req, BizException $e )
	{
	}
}
