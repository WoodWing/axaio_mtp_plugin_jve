...
abstract class AdmCreateUsers_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'AdminService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( AdmCreateUsersRequest &$req );
	abstract public function runAfter( AdmCreateUsersRequest $req, AdmCreateUsersResponse &$resp );
	abstract public function runOverruled( AdmCreateUsersRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param AdmCreateUsersRequest $req The web service request.
