...
abstract class AdmGetTemplateObjects_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'AdminService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( AdmGetTemplateObjectsRequest &$req );
	abstract public function runAfter( AdmGetTemplateObjectsRequest $req, AdmGetTemplateObjectsResponse &$resp );
	abstract public function runOverruled( AdmGetTemplateObjectsRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param AdmGetTemplateObjectsRequest $req The web service request.
	 * @param BizException $e The error thrown.
	 */
	public function onError( AdmGetTemplateObjectsRequest $req, BizException $e )
	{
	}
}
