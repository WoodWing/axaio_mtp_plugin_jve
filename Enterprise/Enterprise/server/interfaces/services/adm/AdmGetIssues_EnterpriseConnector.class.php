...
abstract class AdmGetIssues_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'AdminService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( AdmGetIssuesRequest &$req );
	abstract public function runAfter( AdmGetIssuesRequest $req, AdmGetIssuesResponse &$resp );
	abstract public function runOverruled( AdmGetIssuesRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param AdmGetIssuesRequest $req The web service request.
	 * @param BizException $e The error thrown.
	 */
	public function onError( AdmGetIssuesRequest $req, BizException $e )
	{
	}
}
