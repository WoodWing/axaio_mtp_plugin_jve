...
abstract class AdmModifyStatuses_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'AdminService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( AdmModifyStatusesRequest &$req );
	abstract public function runAfter( AdmModifyStatusesRequest $req, AdmModifyStatusesResponse &$resp );
	abstract public function runOverruled( AdmModifyStatusesRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param AdmModifyStatusesRequest $req The web service request.
	 * @param BizException $e The error thrown.
	 */
	public function onError( AdmModifyStatusesRequest $req, BizException $e )
	{
	}
}
