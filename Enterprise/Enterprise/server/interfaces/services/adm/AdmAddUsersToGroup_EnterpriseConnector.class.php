...
abstract class AdmAddUsersToGroup_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'AdminService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( AdmAddUsersToGroupRequest &$req );
	abstract public function runAfter( AdmAddUsersToGroupRequest $req, AdmAddUsersToGroupResponse &$resp );
	abstract public function runOverruled( AdmAddUsersToGroupRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param AdmAddUsersToGroupRequest $req The web service request.
	 * @param BizException $e The error thrown.
	 */
	public function onError( AdmAddUsersToGroupRequest $req, BizException $e )
	{
	}
}
