...
abstract class AdmCreateIssues_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'AdminService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( AdmCreateIssuesRequest &$req );
	abstract public function runAfter( AdmCreateIssuesRequest $req, AdmCreateIssuesResponse &$resp );
	abstract public function runOverruled( AdmCreateIssuesRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param AdmCreateIssuesRequest $req The web service request.
	 * @param BizException $e The error thrown.
	 */
	public function onError( AdmCreateIssuesRequest $req, BizException $e )
	{
	}
}
