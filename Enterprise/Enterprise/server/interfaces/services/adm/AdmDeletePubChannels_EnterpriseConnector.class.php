...
abstract class AdmDeletePubChannels_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'AdminService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( AdmDeletePubChannelsRequest &$req );
	abstract public function runAfter( AdmDeletePubChannelsRequest $req, AdmDeletePubChannelsResponse &$resp );
	abstract public function runOverruled( AdmDeletePubChannelsRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param AdmDeletePubChannelsRequest $req The web service request.
	 * @param BizException $e The error thrown.
	 */
	public function onError( AdmDeletePubChannelsRequest $req, BizException $e )
	{
	}
}
