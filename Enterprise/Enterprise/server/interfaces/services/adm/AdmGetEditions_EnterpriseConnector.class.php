...
abstract class AdmGetEditions_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'AdminService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( AdmGetEditionsRequest &$req );
	abstract public function runAfter( AdmGetEditionsRequest $req, AdmGetEditionsResponse &$resp );
	abstract public function runOverruled( AdmGetEditionsRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param AdmGetEditionsRequest $req The web service request.
