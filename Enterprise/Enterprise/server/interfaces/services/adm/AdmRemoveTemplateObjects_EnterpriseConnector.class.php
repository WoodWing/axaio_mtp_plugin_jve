...
abstract class AdmRemoveTemplateObjects_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'AdminService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( AdmRemoveTemplateObjectsRequest &$req );
	abstract public function runAfter( AdmRemoveTemplateObjectsRequest $req, AdmRemoveTemplateObjectsResponse &$resp );
	abstract public function runOverruled( AdmRemoveTemplateObjectsRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param AdmRemoveTemplateObjectsRequest $req The web service request.
	 * @param BizException $e The error thrown.
	 */
	public function onError( AdmRemoveTemplateObjectsRequest $req, BizException $e )
	{
	}
}
