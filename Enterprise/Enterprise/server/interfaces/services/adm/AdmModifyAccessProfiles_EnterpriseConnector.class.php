...
abstract class AdmModifyAccessProfiles_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'AdminService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( AdmModifyAccessProfilesRequest &$req );
	abstract public function runAfter( AdmModifyAccessProfilesRequest $req, AdmModifyAccessProfilesResponse &$resp );
	abstract public function runOverruled( AdmModifyAccessProfilesRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param AdmModifyAccessProfilesRequest $req The web service request.
	 * @param BizException $e The error thrown.
	 */
	public function onError( AdmModifyAccessProfilesRequest $req, BizException $e )
	{
	}
}
