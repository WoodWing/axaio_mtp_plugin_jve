...
abstract class AdmGetPublications_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'AdminService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( AdmGetPublicationsRequest &$req );
	abstract public function runAfter( AdmGetPublicationsRequest $req, AdmGetPublicationsResponse &$resp );
	abstract public function runOverruled( AdmGetPublicationsRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param AdmGetPublicationsRequest $req The web service request.
	 * @param BizException $e The error thrown.
	 */
	public function onError( AdmGetPublicationsRequest $req, BizException $e )
	{
