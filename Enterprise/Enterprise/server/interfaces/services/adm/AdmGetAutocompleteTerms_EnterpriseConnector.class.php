...
abstract class AdmGetAutocompleteTerms_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'AdminService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( AdmGetAutocompleteTermsRequest &$req );
	abstract public function runAfter( AdmGetAutocompleteTermsRequest $req, AdmGetAutocompleteTermsResponse &$resp );
	abstract public function runOverruled( AdmGetAutocompleteTermsRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param AdmGetAutocompleteTermsRequest $req The web service request.
	 * @param BizException $e The error thrown.
	 */
	public function onError( AdmGetAutocompleteTermsRequest $req, BizException $e )
	{
