...
abstract class AdmGetAccessProfiles_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'AdminService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( AdmGetAccessProfilesRequest &$req );
	abstract public function runAfter( AdmGetAccessProfilesRequest $req, AdmGetAccessProfilesResponse &$resp );
	abstract public function runOverruled( AdmGetAccessProfilesRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param AdmGetAccessProfilesRequest $req The web service request.
	 * @param BizException $e The error thrown.
	 */
	public function onError( AdmGetAccessProfilesRequest $req, BizException $e )
	{
	}
}
