...
abstract class AdmDeleteIssues_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'AdminService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( AdmDeleteIssuesRequest &$req );
	abstract public function runAfter( AdmDeleteIssuesRequest $req, AdmDeleteIssuesResponse &$resp );
	abstract public function runOverruled( AdmDeleteIssuesRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param AdmDeleteIssuesRequest $req The web service request.
