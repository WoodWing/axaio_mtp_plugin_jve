...
abstract class AdmCreateStatuses_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'AdminService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( AdmCreateStatusesRequest &$req );
	abstract public function runAfter( AdmCreateStatusesRequest $req, AdmCreateStatusesResponse &$resp );
	abstract public function runOverruled( AdmCreateStatusesRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param AdmCreateStatusesRequest $req The web service request.
	 * @param BizException $e The error thrown.
	 */
	public function onError( AdmCreateStatusesRequest $req, BizException $e )
	{
