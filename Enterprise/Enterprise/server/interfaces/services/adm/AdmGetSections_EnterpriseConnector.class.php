...
abstract class AdmGetSections_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'AdminService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( AdmGetSectionsRequest &$req );
	abstract public function runAfter( AdmGetSectionsRequest $req, AdmGetSectionsResponse &$resp );
	abstract public function runOverruled( AdmGetSectionsRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param AdmGetSectionsRequest $req The web service request.
	 * @param BizException $e The error thrown.
	 */
	public function onError( AdmGetSectionsRequest $req, BizException $e )
	{
	}
}
