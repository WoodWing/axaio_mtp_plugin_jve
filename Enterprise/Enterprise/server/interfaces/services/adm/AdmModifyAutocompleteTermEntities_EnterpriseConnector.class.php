...
abstract class AdmModifyAutocompleteTermEntities_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'AdminService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( AdmModifyAutocompleteTermEntitiesRequest &$req );
	abstract public function runAfter( AdmModifyAutocompleteTermEntitiesRequest $req, AdmModifyAutocompleteTermEntitiesResponse &$resp );
	abstract public function runOverruled( AdmModifyAutocompleteTermEntitiesRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param AdmModifyAutocompleteTermEntitiesRequest $req The web service request.
	 * @param BizException $e The error thrown.
	 */
	public function onError( AdmModifyAutocompleteTermEntitiesRequest $req, BizException $e )
	{
	}
}
