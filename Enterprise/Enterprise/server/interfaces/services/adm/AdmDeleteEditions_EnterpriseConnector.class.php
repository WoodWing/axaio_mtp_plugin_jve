...
abstract class AdmDeleteEditions_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'AdminService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( AdmDeleteEditionsRequest &$req );
	abstract public function runAfter( AdmDeleteEditionsRequest $req, AdmDeleteEditionsResponse &$resp );
	abstract public function runOverruled( AdmDeleteEditionsRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param AdmDeleteEditionsRequest $req The web service request.
	 * @param BizException $e The error thrown.
	 */
	public function onError( AdmDeleteEditionsRequest $req, BizException $e )
	{
	}
}
