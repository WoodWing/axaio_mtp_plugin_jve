...
abstract class AdmDeleteUsers_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'AdminService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( AdmDeleteUsersRequest &$req );
	abstract public function runAfter( AdmDeleteUsersRequest $req, AdmDeleteUsersResponse &$resp );
	abstract public function runOverruled( AdmDeleteUsersRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param AdmDeleteUsersRequest $req The web service request.
	 * @param BizException $e The error thrown.
	 */
	public function onError( AdmDeleteUsersRequest $req, BizException $e )
	{
	}
}
