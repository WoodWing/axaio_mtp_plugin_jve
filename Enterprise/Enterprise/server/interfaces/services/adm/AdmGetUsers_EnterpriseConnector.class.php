...
abstract class AdmGetUsers_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'AdminService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( AdmGetUsersRequest &$req );
	abstract public function runAfter( AdmGetUsersRequest $req, AdmGetUsersResponse &$resp );
	abstract public function runOverruled( AdmGetUsersRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param AdmGetUsersRequest $req The web service request.
