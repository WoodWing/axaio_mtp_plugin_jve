...
abstract class AdmDeleteAccessProfiles_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'AdminService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( AdmDeleteAccessProfilesRequest &$req );
	abstract public function runAfter( AdmDeleteAccessProfilesRequest $req, AdmDeleteAccessProfilesResponse &$resp );
	abstract public function runOverruled( AdmDeleteAccessProfilesRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param AdmDeleteAccessProfilesRequest $req The web service request.
