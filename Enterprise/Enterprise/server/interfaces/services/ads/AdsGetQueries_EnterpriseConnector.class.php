...
abstract class AdsGetQueries_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'AdmDatSrcService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( AdsGetQueriesRequest &$req );
	abstract public function runAfter( AdsGetQueriesRequest $req, AdsGetQueriesResponse &$resp );
	abstract public function runOverruled( AdsGetQueriesRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param AdsGetQueriesRequest $req The web service request.
	 * @param BizException $e The error thrown.
	 */
	public function onError( AdsGetQueriesRequest $req, BizException $e )
	{
	}
}
