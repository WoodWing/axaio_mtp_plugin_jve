...
abstract class AdsSaveDatasource_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'AdmDatSrcService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( AdsSaveDatasourceRequest &$req );
	abstract public function runAfter( AdsSaveDatasourceRequest $req, AdsSaveDatasourceResponse &$resp );
	abstract public function runOverruled( AdsSaveDatasourceRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param AdsSaveDatasourceRequest $req The web service request.
