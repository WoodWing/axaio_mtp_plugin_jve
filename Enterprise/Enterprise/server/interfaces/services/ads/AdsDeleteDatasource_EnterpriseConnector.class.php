...
abstract class AdsDeleteDatasource_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'AdmDatSrcService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( AdsDeleteDatasourceRequest &$req );
	abstract public function runAfter( AdsDeleteDatasourceRequest $req, AdsDeleteDatasourceResponse &$resp );
	abstract public function runOverruled( AdsDeleteDatasourceRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param AdsDeleteDatasourceRequest $req The web service request.
