...
abstract class AdsSaveSetting_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'AdmDatSrcService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( AdsSaveSettingRequest &$req );
	abstract public function runAfter( AdsSaveSettingRequest $req, AdsSaveSettingResponse &$resp );
	abstract public function runOverruled( AdsSaveSettingRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param AdsSaveSettingRequest $req The web service request.
	 * @param BizException $e The error thrown.
	 */
	public function onError( AdsSaveSettingRequest $req, BizException $e )
	{
	}
}
