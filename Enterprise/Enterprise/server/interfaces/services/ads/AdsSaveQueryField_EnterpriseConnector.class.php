...
abstract class AdsSaveQueryField_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'AdmDatSrcService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( AdsSaveQueryFieldRequest &$req );
	abstract public function runAfter( AdsSaveQueryFieldRequest $req, AdsSaveQueryFieldResponse &$resp );
	abstract public function runOverruled( AdsSaveQueryFieldRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param AdsSaveQueryFieldRequest $req The web service request.
	 * @param BizException $e The error thrown.
	 */
	public function onError( AdsSaveQueryFieldRequest $req, BizException $e )
	{
