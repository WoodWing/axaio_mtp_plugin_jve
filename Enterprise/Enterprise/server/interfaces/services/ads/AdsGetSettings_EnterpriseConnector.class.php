...
abstract class AdsGetSettings_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'AdmDatSrcService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( AdsGetSettingsRequest &$req );
	abstract public function runAfter( AdsGetSettingsRequest $req, AdsGetSettingsResponse &$resp );
	abstract public function runOverruled( AdsGetSettingsRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param AdsGetSettingsRequest $req The web service request.
	 * @param BizException $e The error thrown.
	 */
	public function onError( AdsGetSettingsRequest $req, BizException $e )
	{
	}
}
