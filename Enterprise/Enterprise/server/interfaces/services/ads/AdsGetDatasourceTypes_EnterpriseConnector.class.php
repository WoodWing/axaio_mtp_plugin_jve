...
abstract class AdsGetDatasourceTypes_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'AdmDatSrcService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( AdsGetDatasourceTypesRequest &$req );
	abstract public function runAfter( AdsGetDatasourceTypesRequest $req, AdsGetDatasourceTypesResponse &$resp );
	abstract public function runOverruled( AdsGetDatasourceTypesRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param AdsGetDatasourceTypesRequest $req The web service request.
	 * @param BizException $e The error thrown.
	 */
	public function onError( AdsGetDatasourceTypesRequest $req, BizException $e )
	{
	}
}
