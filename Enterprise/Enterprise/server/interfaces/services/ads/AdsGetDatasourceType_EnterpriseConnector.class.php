...
abstract class AdsGetDatasourceType_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'AdmDatSrcService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( AdsGetDatasourceTypeRequest &$req );
	abstract public function runAfter( AdsGetDatasourceTypeRequest $req, AdsGetDatasourceTypeResponse &$resp );
	abstract public function runOverruled( AdsGetDatasourceTypeRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param AdsGetDatasourceTypeRequest $req The web service request.
	 * @param BizException $e The error thrown.
	 */
	public function onError( AdsGetDatasourceTypeRequest $req, BizException $e )
	{
