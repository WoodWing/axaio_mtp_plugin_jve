...
abstract class AdsDeleteQueryField_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'AdmDatSrcService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( AdsDeleteQueryFieldRequest &$req );
	abstract public function runAfter( AdsDeleteQueryFieldRequest $req, AdsDeleteQueryFieldResponse &$resp );
	abstract public function runOverruled( AdsDeleteQueryFieldRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param AdsDeleteQueryFieldRequest $req The web service request.
