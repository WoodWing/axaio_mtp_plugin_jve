...
abstract class AdsGetDatasourceInfo_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'AdmDatSrcService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( AdsGetDatasourceInfoRequest &$req );
	abstract public function runAfter( AdsGetDatasourceInfoRequest $req, AdsGetDatasourceInfoResponse &$resp );
	abstract public function runOverruled( AdsGetDatasourceInfoRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param AdsGetDatasourceInfoRequest $req The web service request.
	 * @param BizException $e The error thrown.
	 */
	public function onError( AdsGetDatasourceInfoRequest $req, BizException $e )
	{
	}
}
