...
abstract class AdsCopyQuery_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'AdmDatSrcService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( AdsCopyQueryRequest &$req );
	abstract public function runAfter( AdsCopyQueryRequest $req, AdsCopyQueryResponse &$resp );
	abstract public function runOverruled( AdsCopyQueryRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param AdsCopyQueryRequest $req The web service request.
	 * @param BizException $e The error thrown.
	 */
	public function onError( AdsCopyQueryRequest $req, BizException $e )
	{
	}
}
