...
abstract class AdsGetSettingsDetails_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'AdmDatSrcService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( AdsGetSettingsDetailsRequest &$req );
	abstract public function runAfter( AdsGetSettingsDetailsRequest $req, AdsGetSettingsDetailsResponse &$resp );
	abstract public function runOverruled( AdsGetSettingsDetailsRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param AdsGetSettingsDetailsRequest $req The web service request.
	 * @param BizException $e The error thrown.
	 */
	public function onError( AdsGetSettingsDetailsRequest $req, BizException $e )
	{
	}
}
