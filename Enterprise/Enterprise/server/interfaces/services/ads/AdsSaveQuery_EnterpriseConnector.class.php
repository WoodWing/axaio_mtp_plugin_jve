...
abstract class AdsSaveQuery_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'AdmDatSrcService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( AdsSaveQueryRequest &$req );
	abstract public function runAfter( AdsSaveQueryRequest $req, AdsSaveQueryResponse &$resp );
	abstract public function runOverruled( AdsSaveQueryRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param AdsSaveQueryRequest $req The web service request.
	 * @param BizException $e The error thrown.
	 */
	public function onError( AdsSaveQueryRequest $req, BizException $e )
	{
	}
}
