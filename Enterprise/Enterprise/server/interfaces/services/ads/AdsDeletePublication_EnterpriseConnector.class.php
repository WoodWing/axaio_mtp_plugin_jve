...
abstract class AdsDeletePublication_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'AdmDatSrcService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( AdsDeletePublicationRequest &$req );
	abstract public function runAfter( AdsDeletePublicationRequest $req, AdsDeletePublicationResponse &$resp );
	abstract public function runOverruled( AdsDeletePublicationRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param AdsDeletePublicationRequest $req The web service request.
	 * @param BizException $e The error thrown.
	 */
	public function onError( AdsDeletePublicationRequest $req, BizException $e )
	{
