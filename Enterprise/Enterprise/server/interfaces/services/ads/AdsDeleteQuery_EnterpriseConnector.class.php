...
abstract class AdsDeleteQuery_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'AdmDatSrcService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( AdsDeleteQueryRequest &$req );
	abstract public function runAfter( AdsDeleteQueryRequest $req, AdsDeleteQueryResponse &$resp );
	abstract public function runOverruled( AdsDeleteQueryRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param AdsDeleteQueryRequest $req The web service request.
