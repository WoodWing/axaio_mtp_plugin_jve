...
abstract class AdsSavePublication_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'AdmDatSrcService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( AdsSavePublicationRequest &$req );
	abstract public function runAfter( AdsSavePublicationRequest $req, AdsSavePublicationResponse &$resp );
	abstract public function runOverruled( AdsSavePublicationRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param AdsSavePublicationRequest $req The web service request.
	 * @param BizException $e The error thrown.
	 */
	public function onError( AdsSavePublicationRequest $req, BizException $e )
	{
	}
}
