...
abstract class AdsGetPublications_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'AdmDatSrcService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( AdsGetPublicationsRequest &$req );
	abstract public function runAfter( AdsGetPublicationsRequest $req, AdsGetPublicationsResponse &$resp );
	abstract public function runOverruled( AdsGetPublicationsRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param AdsGetPublicationsRequest $req The web service request.
	 * @param BizException $e The error thrown.
	 */
	public function onError( AdsGetPublicationsRequest $req, BizException $e )
	{
	}
}
