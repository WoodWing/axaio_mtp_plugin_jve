...
abstract class AdsCopyDatasource_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'AdmDatSrcService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( AdsCopyDatasourceRequest &$req );
	abstract public function runAfter( AdsCopyDatasourceRequest $req, AdsCopyDatasourceResponse &$resp );
	abstract public function runOverruled( AdsCopyDatasourceRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param AdsCopyDatasourceRequest $req The web service request.
