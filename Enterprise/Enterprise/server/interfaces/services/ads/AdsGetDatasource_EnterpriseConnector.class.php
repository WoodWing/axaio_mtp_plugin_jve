...
abstract class AdsGetDatasource_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'AdmDatSrcService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( AdsGetDatasourceRequest &$req );
	abstract public function runAfter( AdsGetDatasourceRequest $req, AdsGetDatasourceResponse &$resp );
	abstract public function runOverruled( AdsGetDatasourceRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param AdsGetDatasourceRequest $req The web service request.
	 * @param BizException $e The error thrown.
	 */
	public function onError( AdsGetDatasourceRequest $req, BizException $e )
	{
	}
}
