...
abstract class AdsNewQuery_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'AdmDatSrcService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( AdsNewQueryRequest &$req );
	abstract public function runAfter( AdsNewQueryRequest $req, AdsNewQueryResponse &$resp );
	abstract public function runOverruled( AdsNewQueryRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param AdsNewQueryRequest $req The web service request.
	 * @param BizException $e The error thrown.
	 */
	public function onError( AdsNewQueryRequest $req, BizException $e )
	{
	}
}
