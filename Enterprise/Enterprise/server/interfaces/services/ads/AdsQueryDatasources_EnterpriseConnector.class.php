...
abstract class AdsQueryDatasources_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'AdmDatSrcService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( AdsQueryDatasourcesRequest &$req );
	abstract public function runAfter( AdsQueryDatasourcesRequest $req, AdsQueryDatasourcesResponse &$resp );
	abstract public function runOverruled( AdsQueryDatasourcesRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param AdsQueryDatasourcesRequest $req The web service request.
	 * @param BizException $e The error thrown.
	 */
	public function onError( AdsQueryDatasourcesRequest $req, BizException $e )
	{
	}
}
