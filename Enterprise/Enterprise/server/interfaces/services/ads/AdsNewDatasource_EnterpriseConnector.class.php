...
abstract class AdsNewDatasource_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'AdmDatSrcService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( AdsNewDatasourceRequest &$req );
	abstract public function runAfter( AdsNewDatasourceRequest $req, AdsNewDatasourceResponse &$resp );
	abstract public function runOverruled( AdsNewDatasourceRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param AdsNewDatasourceRequest $req The web service request.
	 * @param BizException $e The error thrown.
	 */
	public function onError( AdsNewDatasourceRequest $req, BizException $e )
	{
