...
abstract class AdsGetQueryFields_EnterpriseConnector extends ServiceConnector 
{
	final public function getConnectorType()    { return 'AdmDatSrcService'; }
	final public function getInterfaceVersion() { return 1; }

	abstract public function runBefore( AdsGetQueryFieldsRequest &$req );
	abstract public function runAfter( AdsGetQueryFieldsRequest $req, AdsGetQueryFieldsResponse &$resp );
	abstract public function runOverruled( AdsGetQueryFieldsRequest $req );
	 ...
	 *
	 * @since 9.7.0
	 * @param AdsGetQueryFieldsRequest $req The web service request.
