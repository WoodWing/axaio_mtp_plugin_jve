...
class WW_TestSuite_BuildTest_Elvis_CopyToProductZone_Teardown_TestCase extends TestCase
{
	...
	final public function runTest()
	{
		...
		$origValue = $vars['BuildTest_Elvis_CopyToProductZone']['ELVIS_CREATE_COPY'];
