...
// * - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
	...
	$server->setClassMap( 'com.woodwing.enterprise.interfaces.services.adm.dataclasses.AdmPubChannel', 'AdmPubChannel' );
	$server->setClassMap( 'com.woodwing.enterprise.interfaces.services.adm.dataclasses.AdmIssue', 'AdmIssue' );
	$server->setClassMap( 'com.woodwing.enterprise.interfaces.services.adm.dataclasses.AdmExtraMetaData', 'AdmExtraMetaData' );
