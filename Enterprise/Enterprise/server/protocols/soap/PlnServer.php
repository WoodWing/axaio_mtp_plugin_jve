...
class WW_SOAP_PlnServer extends WW_SOAP_Server 
{
	public function __construct($wsdl, array $options = array())
	{
		...
		// soap handler class
		require_once BASEDIR . '/server/protocols/soap/PlnServices.php';
		$className = 'WW_SOAP_PlnServices';
