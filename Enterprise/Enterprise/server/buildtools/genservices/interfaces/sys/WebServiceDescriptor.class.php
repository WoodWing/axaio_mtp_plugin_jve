...
class WW_BuildTools_GenServices_Interfaces_Sys_WebServiceDescriptor implements WW_BuildTools_GenServices_Interfaces_WebServiceDescriptorInterface
{
	...
	{
		return BASEDIR.'/server/interfaces/services/sys/DataClasses.php';
	}
	...
	{
		return 'urn:SmartConnectionSysAdmin';
	}
	...
	{
		return "LOCALURL_ROOT.INETROOT.'/sysadminindex.php'";
	}

	final public function getExternalSoapEntryPoint()
	{
		return "SERVERURL_ROOT.INETROOT.'/sysadminindex.php'";
	}

	final public function getWsdlFilePath()
	{
		return BASEDIR.'/server/interfaces/SystemAdmin.wsdl';
	}
