...
require_once BASEDIR.'/server/interfaces/services/adm/AdmModifyRoutingsResponse.class.php';
require_once BASEDIR.'/server/services/EnterpriseService.class.php';

class AdmModifyRoutingsService extends EnterpriseService
{
	public function execute( AdmModifyRoutingsRequest $req )
	{
	...
	public function runCallback( AdmModifyRoutingsRequest $req )
	{
		require_once BASEDIR.'/server/bizclasses/BizAdmRouting.class.php';
		$routings = BizAdmRouting::modifyRoutings( $req->Routings );
		$response = new AdmModifyRoutingsResponse();
