<?php
/**
 * PublishDossiers Publishing service.
 *
 * @since v6.0
...
require_once BASEDIR.'/server/interfaces/services/pub/PubPublishDossiersResponse.class.php';
require_once BASEDIR.'/server/services/EnterpriseService.class.php';

class PubPublishDossiersService extends EnterpriseService
{
	public function execute( PubPublishDossiersRequest $req )
	{
		...
		// Call publishing service connectors, and/or ourself through runCallback().
	...
	public function runCallback( PubPublishDossiersRequest $req )
	{
		...
		$dossiers = $bizPublishing->processDossiers( $req->PublishedDossiers, 'Publish', $req->OperationId );

		// Return published dossiers info to caller.
		$response = new PubPublishDossiersResponse();
