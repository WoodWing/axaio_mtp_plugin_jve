...
var DEFAULT_CONFIG={
	UNCHECKED_NORM:"../../config/images/tristate/unchecked.gif",
	UNCHECKED_HILI:"../../config/images/tristate/unchecked_highlighted.gif",
	INTERMEDIATE_NORM:"../../config/images/tristate/intermediate.gif",
	INTERMEDIATE_HILI:"../../config/images/tristate/intermediate_highlighted.gif",
	CHECKED_NORM:"../../config/images/tristate/checked.gif",
	CHECKED_HILI:"../../config/images/tristate/checked_highlighted.gif"
};
...
function selectOrUnselectBoxes(checkBoxes, selectBoxes) {
	for (var x in checkBoxes) {
		...
		if( checkBoxes[x].checked != selectBoxes ) {
			checkBoxes[x].click(); // simulate use click to trigger (hierarchical!) listeners
		}
		/// <<<
	}
}
