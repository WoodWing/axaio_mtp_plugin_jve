<?php
	 ...
	 *
	 * @param array with POST (form) fields
	 * @param $url page to post to
	 * @param $proxyInfo optional array that specifies proxy server settings
	 * @return The response of the remote server (not including the header), or: 
