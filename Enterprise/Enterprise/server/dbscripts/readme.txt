...
SQL scripts are generated with the server/buildtools/dbgen.php tool and written in this folder.
...
Server plugins may provide their own DB model which will be automatically picked up by the tools mentioned.
