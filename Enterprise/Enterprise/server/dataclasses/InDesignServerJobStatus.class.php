 ...
 *
 * InDesign Server Job execution status
 */

class InDesignServerJobStatus
{
	// Job Condition
...
//  const DISABLED  = 0x4460; // (=17504) job was created, but at execution time, no IDS server enabled to handle
	...
	public function getStatusLocalized()
	{
		switch( $this->Status ) {
			...
			case self::UNAVAILABLE:  $ret = BizResources::localize('SVR_JOBSTATUS_UNAVAILABLE'); break;
			case self::LOCKED:       $ret = BizResources::localize('SVR_JOBSTATUS_LOCKED'); break;
			case self::INCOMPATIBLE: $ret = BizResources::localize('SVR_JOBSTATUS_INCOMPATIBLE'); break;
	...
	public function getStatusInfoLocalized()
	{
		switch( $this->Status ) {
			...
			case self::UNAVAILABLE:  $ret = BizResources::localize('SVR_JOBSTATUS_UNAVAILABLE_INFO'); break;
			case self::LOCKED:       $ret = BizResources::localize('SVR_JOBSTATUS_LOCKED_INFO'); break;
			case self::INCOMPATIBLE: $ret = BizResources::localize('SVR_JOBSTATUS_INCOMPATIBLE_INFO'); break;
	...
	public function getProgressLocalized()
	{
		switch( $this->Status & self::PRGS ) {
			...
			case self::DONE: $ret = BizResources::localize('SVR_JOBPROGRESS_DONE'); break;
			case self::HALT: $ret = BizResources::localize('SVR_JOBPROGRESS_HALT'); break;
			default: $ret = BizResources::localize('ERR_ARGUMENT'); break;
		}
		return $ret;
	}
