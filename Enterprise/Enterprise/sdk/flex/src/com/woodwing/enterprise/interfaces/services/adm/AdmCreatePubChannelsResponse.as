...
{
	[Bindable]
	[RemoteClass(alias="com.woodwing.enterprise.interfaces.services.adm.AdmCreatePubChannelsResponse")]

	public class AdmCreatePubChannelsResponse
	{
		private var _PublicationId:Number;
		private var _PubChannels:Array;

		public function AdmCreatePubChannelsResponse() {
		}
