...
{
	[Bindable]
	[RemoteClass(alias="com.woodwing.enterprise.interfaces.services.adm.AdmCreateIssuesResponse")]

	public class AdmCreateIssuesResponse
	{
		private var _PublicationId:Number;
		private var _PubChannelId:Number;
		private var _Issues:Array;

		public function AdmCreateIssuesResponse() {
		}
