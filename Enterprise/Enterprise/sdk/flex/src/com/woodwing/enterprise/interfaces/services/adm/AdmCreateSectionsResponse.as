...
{
	[Bindable]
	[RemoteClass(alias="com.woodwing.enterprise.interfaces.services.adm.AdmCreateSectionsResponse")]

	public class AdmCreateSectionsResponse
	{
		private var _PublicationId:Number;
		private var _IssueId:Number;
		private var _Sections:Array;

		public function AdmCreateSectionsResponse() {
		}
