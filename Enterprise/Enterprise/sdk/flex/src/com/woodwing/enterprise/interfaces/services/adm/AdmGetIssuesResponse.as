...
{
	[Bindable]
	[RemoteClass(alias="com.woodwing.enterprise.interfaces.services.adm.AdmGetIssuesResponse")]

	public class AdmGetIssuesResponse
	{
		private var _PublicationId:Number;
		private var _PubChannelId:Number;
		private var _Issues:Array;

		public function AdmGetIssuesResponse() {
		}
