...
{
	[Bindable]
	[RemoteClass(alias="com.woodwing.enterprise.interfaces.services.adm.AdmRemoveUsersFromGroupRequest")]

	public class AdmRemoveUsersFromGroupRequest
	{
		private var _Ticket:String;
		private var _UserIds:Array;
		private var _GroupId:Number;

		public function AdmRemoveUsersFromGroupRequest() {
		}
