...
{
	[Bindable]
	[RemoteClass(alias="com.woodwing.enterprise.interfaces.services.adm.AdmGetSectionsResponse")]

	public class AdmGetSectionsResponse
	{
		private var _PublicationId:Number;
		private var _IssueId:Number;
		private var _Sections:Array;

		public function AdmGetSectionsResponse() {
		}
