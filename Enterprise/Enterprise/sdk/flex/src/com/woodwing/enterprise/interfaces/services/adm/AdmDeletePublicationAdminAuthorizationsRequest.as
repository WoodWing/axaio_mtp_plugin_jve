...
{
	[Bindable]
	[RemoteClass(alias="com.woodwing.enterprise.interfaces.services.adm.AdmDeletePublicationAdminAuthorizationsRequest")]

	public class AdmDeletePublicationAdminAuthorizationsRequest
	{
		private var _Ticket:String;
		private var _PublicationId:Number;
		private var _UserGroupIds:Array;

		public function AdmDeletePublicationAdminAuthorizationsRequest() {
		}
