...
public class LogOffRequest  implements java.io.Serializable {
    ...
    /**
     * Gets the ticket value for this LogOffRequest.
     * 
     * @return ticket
     */
    ...
    /**
     * Sets the ticket value for this LogOffRequest.
     * 
     * @param ticket
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:SmartConnectionAdmin", ">LogOffRequest"));
