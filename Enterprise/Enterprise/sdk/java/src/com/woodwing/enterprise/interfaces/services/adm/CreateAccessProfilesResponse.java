/**
 * CreateAccessProfilesResponse.java
 *
...
public class CreateAccessProfilesResponse  implements java.io.Serializable {
    private com.woodwing.enterprise.interfaces.services.adm.AccessProfile[] accessProfiles;

    public CreateAccessProfilesResponse() {
    }
    ...
    /**
     * Gets the accessProfiles value for this CreateAccessProfilesResponse.
     * 
    ...
    /**
     * Sets the accessProfiles value for this CreateAccessProfilesResponse.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof CreateAccessProfilesResponse)) return false;
        CreateAccessProfilesResponse other = (CreateAccessProfilesResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(CreateAccessProfilesResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:SmartConnectionAdmin", ">CreateAccessProfilesResponse"));
