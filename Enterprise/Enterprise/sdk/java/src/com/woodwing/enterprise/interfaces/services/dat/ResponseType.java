...
public class ResponseType implements java.io.Serializable {
    ...
    public static final ResponseType none = new ResponseType(_none);
    public static final ResponseType accepted = new ResponseType(_accepted);
    public static final ResponseType rejected = new ResponseType(_rejected);
    public static final ResponseType ignored = new ResponseType(_ignored);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:PlutusDatasource", "ResponseType"));
    }
    /**
