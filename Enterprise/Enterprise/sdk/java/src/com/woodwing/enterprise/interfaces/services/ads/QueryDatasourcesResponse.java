...
public class QueryDatasourcesResponse  implements java.io.Serializable {
    private com.woodwing.enterprise.interfaces.services.ads.DatasourceInfo[] datasources;

    public QueryDatasourcesResponse() {
    }

    public QueryDatasourcesResponse(
           com.woodwing.enterprise.interfaces.services.ads.DatasourceInfo[] datasources) {
     ...
     * @return datasources
     */
    public com.woodwing.enterprise.interfaces.services.ads.DatasourceInfo[] getDatasources() {
        return datasources;
    }
     ...
     * @param datasources
     */
    public void setDatasources(com.woodwing.enterprise.interfaces.services.ads.DatasourceInfo[] datasources) {
        this.datasources = datasources;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:PlutusAdmin", ">QueryDatasourcesResponse"));
