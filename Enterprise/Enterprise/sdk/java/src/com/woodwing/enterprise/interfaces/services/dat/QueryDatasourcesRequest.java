...
public class QueryDatasourcesRequest  implements java.io.Serializable {
    ...
    /**
     * Gets the publicationID value for this QueryDatasourcesRequest.
     * 
    ...
    /**
     * Sets the publicationID value for this QueryDatasourcesRequest.
     * 
     * @param publicationID
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:PlutusDatasource", ">QueryDatasourcesRequest"));
