...
public class GetSectionsRequest  implements java.io.Serializable {
    ...
    private java.math.BigInteger[] sectionIds;
    ...
    public GetSectionsRequest(
           ...
           java.math.BigInteger[] sectionIds) {
           this.ticket = ticket;
    ...
    /**
     * Gets the ticket value for this GetSectionsRequest.
     * 
     * @return ticket
     */
    ...
    /**
     * Sets the ticket value for this GetSectionsRequest.
     * 
     * @param ticket
     */
    ...
    /**
     * Gets the requestModes value for this GetSectionsRequest.
     * 
     * @return requestModes
     */
    ...
    /**
     * Sets the requestModes value for this GetSectionsRequest.
     * 
     * @param requestModes
     */
    ...
    /**
     * Gets the publicationId value for this GetSectionsRequest.
     * 
    ...
    /**
     * Sets the publicationId value for this GetSectionsRequest.
     * 
     * @param publicationId
     */
    ...
    /**
     * Gets the issueId value for this GetSectionsRequest.
     * 
     * @return issueId
     */
    ...
    /**
     * Sets the issueId value for this GetSectionsRequest.
     * 
     * @param issueId
     */
    ...
    /**
     * Gets the sectionIds value for this GetSectionsRequest.
     * 
     * @return sectionIds
     */
    public java.math.BigInteger[] getSectionIds() {
        return sectionIds;
    }


    /**
     * Sets the sectionIds value for this GetSectionsRequest.
     * 
     * @param sectionIds
     */
    public void setSectionIds(java.math.BigInteger[] sectionIds) {
        this.sectionIds = sectionIds;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof GetSectionsRequest)) return false;
        GetSectionsRequest other = (GetSectionsRequest) obj;
        ...
        _equals = true && 
            ...
            ((this.sectionIds==null && other.getSectionIds()==null) || 
             (this.sectionIds!=null &&
              java.util.Arrays.equals(this.sectionIds, other.getSectionIds())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getSectionIds() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getSectionIds());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getSectionIds(), i);
                if (obj != null &&
                    !obj.getClass().isArray()) {
                    _hashCode += obj.hashCode();
                }
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GetSectionsRequest.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:SmartConnectionAdmin", ">GetSectionsRequest"));
        ...
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("sectionIds");
        elemField.setXmlName(new javax.xml.namespace.QName("", "SectionIds"));
