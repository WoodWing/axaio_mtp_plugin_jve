...
class NumberUtils
{
	...
	/**
	 * Returns a list of php versions that are configured.
	 *
	 * See PROXY_PHPVERSIONS option in config.php file for more info.
	 *
	...
	static private function getConfiguredPhpVersions()
	{
		...
		if( is_null($phpVersions) ) {
			$phpVersions = unserialize(PROXY_PHPVERSIONS);
		}
	...
	/**
	 * Returns a list of php versions that are supported.
	 *
	 * See PROXY_PHPVERSIONS option in config.php file for more info.
	 *
	...
	/**
	 * Returns a list of php versions that are NOT supported.
	 *
	 * See PROXY_PHPVERSIONS option in config.php file for more info.
	 *
	...
	/**
	 * Tells whether or not a given php version is supported.
	 *
	 * See PROXY_PHPVERSIONS option in config.php file for more info.
	 *
	...
	{
		// Take the php versions that are supported.
